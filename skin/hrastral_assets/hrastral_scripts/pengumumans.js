$(document).ready(function() {
	...
	jQuery("#aj_perusahaan").change(function(){
		jQuery.get(escapeHtmlSecure(site_url+"karyawans/get_perusahaan_elocations/"+jQuery(this).val()), function(data, status){
	...
	$('.edit-modal-data').on('show.bs.modal', function (event) {
		...
		$.ajax({
			url : base_url+'/read/',
			type: "GET",
			data: 'jd=1&is_ajax=1&mode=modal&data=pengumuman&pengumuman_id='+pengumuman_id,
