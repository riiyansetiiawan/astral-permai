$(document).ready(function(){
	...
	var umb_comment_table = $('#umb_comment_table').dataTable({
		"bDestroy": true,
		"ajax": {
			url : base_url+"/list_comments/"+$('#comment_ticket_id').val(),
			type : 'GET'
		},
	...
	var umb_attachment_table = $('#umb_attachment_table').dataTable({
		"bDestroy": true,
		"ajax": {
			url : base_url+"/list_attachment/"+$('#c_ticket_id').val(),
			type : 'GET'
		},
		"fnDrawCallback": function(settings){
			$('[data-toggle="tooltip"]').tooltip();          
...
$( document ).on( "click", ".delete", function() {
	...
	$('#delete_record').attr('action',base_url+'/delete_comment_ticket/'+$(this).data('record-id'));
});
/// delete a file
$( document ).on( "click", ".delete-file", function() {
	$('input[name=_token_del_file]').val($(this).data('record-id'));
	$('#delete_record_f').attr('action',base_url+'/delete_attachment_ticket/'+$(this).data('record-id'));
});