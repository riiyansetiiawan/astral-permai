...
Chart.defaults.global.legend.display = false;  
   ...
   var hrastral_projects = new Chart(document.getElementById('hrastral_projects').getContext("2d"), {
    type: 'bar',
    data: {
      datasets: [{
  ...
  var hrastral_tugass = new Chart(document.getElementById('hrastral_tugass').getContext("2d"), {
    type: 'line',
    data: {
      datasets: [{
        data: [24, 92, 77, 90, 91, 78, 28, 49, 23, 81, 15, 97, 94, 16, 99, 61,
  ...
  var hrastral_department = new Chart(document.getElementById('hrastral_department').getContext("2d"), {
    type: 'pie',
    data: {
  ...
  var hrastral_penunjukan = new Chart(document.getElementById('hrastral_penunjukan').getContext("2d"), {
    type: 'pie',
    data: {
  ...
  function resizeCharts() {
	hrastral_payroll.resize();
	hrastral_projects.resize();
    hrastral_tugass.resize();
    hrastral_department.resize();
    hrastral_penunjukan.resize();
  }
