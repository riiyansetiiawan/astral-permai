$(document).ready(function() {
	...
	jQuery("#aj_perusahaan_emp").change(function(){
		jQuery.get(base_url+"/get_perusahaan_elocations/"+jQuery(this).val(), function(data, status){
			jQuery('#ajax_location').html(data);
		});
		jQuery.get(base_url+"/get_perusahaan_shifts_kantor/"+jQuery(this).val(), function(data, status){
	...
	jQuery("#filter_perusahaan").change(function(){
		...
		jQuery.get(site_url+"karyawans/filter_perusahaan_f_locations/"+jQuery(this).val(), function(data, status){
