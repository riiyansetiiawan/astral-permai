$(document).ready(function() {
    ...
    jQuery(".hrastral_layout").change(function() {
        ...
        $.ajax({
            type: "GET",
            url: site_url + "settings/info_layout_skin/?is_ajax=2&type=hrastral_info_layout&form=2&fixed_layout_hrastral=" + fixed_layout_hrastral + "&boxed_layout_hrastral=" + boxed_layout_hrastral + "&sidebar_layout_hrastral=" + sidebar_layout_hrastral + "&user_session_id=" + user_session_id,
            //data: order,
            success: function(response) {
                if (response.error != '') {
