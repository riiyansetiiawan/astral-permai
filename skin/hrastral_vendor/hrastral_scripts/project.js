$(document).ready(function() {
	...
	jQuery("#aj_perusahaan").change(function(){
		jQuery.get(site_url+"quotes/get_karyawans/"+jQuery(this).val(), function(data, status){
			jQuery('#pajax_karyawan').html(data);
		});
	});
	jQuery("#aj_perusahaan").change(function(){
		jQuery.get(site_url+"quotes/get_co_karyawans/"+jQuery(this).val(), function(data, status){
			jQuery('#cajax_karyawan').html(data);
		});
	});
