      ...
      <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            <h4 class="text-center">Setup Setings Database</h4>
            <hr/>
            <form class="form-horizontal" id="install_form" method="post" action="install_application.php" autocomplete="off">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  ...
                  <span style="font-size:12px;">If 'localhost' tidak berfungsi, Anda bisa mendapatkan nama host dari host web</span>
                </div>
              </div>
              <hr>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-3 control-label">Username Database</label>
                <div class="col-sm-8">
                  <input class="form-control" type="text" name="username" value="root">
                  <span style="font-size:12px;">Username Database Anda</span>
                </div>
              </div>
              <hr>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-3 control-label">Password Database</label>
                <div class="col-sm-8">
                  <input class="form-control" type="password" id="password" name="password">
                  <span style="font-size:12px;">Password database anda</span>
                </div>
              </div>
              <hr>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-3 control-label">Nama Database</label>
                <div class="col-sm-8">
                  <input class="form-control" type="text" id="database" name="database">
                  <span style="font-size:12px;">Nama database anda</span>
                </div>
              </div>
              <hr>
            ...
            <p class="error text-center">Harap pastikan application/config/database.php file dapat ditulis.<br />
