...
class MY_Model extends CI_Model
{
    ...
    protected $_temporary_with_dihapus = FALSE;
    protected $_temporary_only_dihapus = FALSE;
    ...
    public function get_by()
    {
        ...
        if ($this->soft_delete && $this->_temporary_with_dihapus !== TRUE)
        {
            $this->_database->where($this->soft_delete_key, (bool)$this->_temporary_only_dihapus);
        }
     ...
     */
    public function with_dihapus()
    {
        $this->_temporary_with_dihapus = TRUE;
        return $this;
    }
     ...
     */
    public function only_dihapus()
    {
        $this->_temporary_only_dihapus = TRUE;
        return $this;
    }
