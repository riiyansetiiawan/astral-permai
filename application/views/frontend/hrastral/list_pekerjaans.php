			...
			<div class="widget">
				...
				<ul class="footer-links">
					<?php foreach($all_types_pekerjaan->result() as $type_pekerjaan):?>
						<?php $count_pekerjaans = $this->Recruitment_model->record_count_type_pekerjaan($type_pekerjaan->type_url);?>
						<?php if($count_pekerjaans > 0){?>
							<li><a href="<?php echo site_url('pekerjaans/search/type/').$type_pekerjaan->type_url;?>"><?php echo $type_pekerjaan->type;?> (<?php echo $this->Recruitment_model->record_count_type_pekerjaan($type_pekerjaan->type_url);?>)</a></li>
						<?php } ?>
					<?php endforeach;?>
				</ul>
