...
<div class="card-header with-elements"> <span class="card-header-title mr-2">&nbsp;</span>
      ...
      <a href="javascript:void(0);" class="btn btn-sm btn-outline-primary waves-effect waves-light"  data-toggle="modal" data-target=".add-modal-data"  data-invoice_id="<?php echo $invoice_id; ?>"><span class="fa fa-exchange"></span> <?php echo $this->lang->line('umb_invoice_pay');?></a>
      <a href="<?php echo site_url('admin/invoices/edit/'.$invoice_id);?>" class="btn btn-outline-primary btn-sm waves-effect waves-light"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?php echo $this->lang->line('umb_edit');?></a>
      </div>
    </div>
   <?php } ?> 
