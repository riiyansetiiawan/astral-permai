...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  ...
  <?php if(in_array('426',$role_resources_ids)) { ?>
    <li class="nav-item active"> <a href="<?php echo site_url('admin/invoices/calendar_invoice/');?>" data-link-data="<?php echo site_url('admin/invoices/calendar_invoice/');?>" class="mb-3 nav-link hrastral-link"> <span class="sw-icon fas fa-calendar-alt"></span> <?php echo $this->lang->line('umb_calendar_invoice');?>
  ...
  <div class="col-md-3">
    <div class="card">
      ...
      <div class="list-group" id="list_group">
        <span class="list-group-item calendar-options text-green hrastral-drag-option" data-record="0"> <i class="ion ion-md-done-all text-success"></i> &nbsp; <?php echo $this->lang->line('umb_invoice_completed');?></span>
        <span class="list-group-item calendar-options text-yellow hrastral-drag-option" data-record="0"> <i class="ion ion-md-flash-off text-warning"></i> &nbsp; <?php echo $this->lang->line('umb_invoice_pending');?></span>
      </div>  
      <div class="card-body">
