...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  ...
  <?php if(in_array('51',$role_resources_ids)) { ?>
    <li class="nav-item active"> <a href="<?php echo site_url('admin/kandidats_pekerjaan/');?>" data-link-data="<?php echo site_url('admin/kandidats_pekerjaan/');?>" class="mb-3 nav-link hrastral-link"> <span class="sw-icon fas fa-user-friends"></span> <?php echo $this->lang->line('left_kandidats_pekerjaan');?>
...
<div class="card <?php echo $get_animate;?>">
  <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_list_all');?></strong> <?php echo $this->lang->line('left_kandidats_pekerjaan');?></span> </div>
  <div class="card-body">
