...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('umb_pekerjaans_edit_cms_page');?></h4>
</div>
...
<?php echo form_open('admin/post_pekerjaan/update_pages/'.$page_id, $attributes, $hidden);?>
<div class="modal-body">
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          <label for="name"><?php echo $this->lang->line('dashboard_umb_title');?></label>
      ...
      <div class="col-md-9">
        <div class="form-group">
          <label for="subject"><?php echo $this->lang->line('umb_pekerjaans_page_url');?></label>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="message"><?php echo $this->lang->line('umb_pekerjaans_page_content');?></label>
          <textarea class="form-control" placeholder="<?php echo $this->lang->line('umb_pekerjaans_page_content');?>" name="page_details" id="summernote"><?php echo $page_details;?></textarea>
        </div>
      </div>
    </div>
  </div>
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var umb_table = $('#umb_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("admin/post_pekerjaan/list_pages") ?>",
							type : 'GET'
						},
