...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('umb_pekerjaans_cover_letter_for').' '.$result[0]->title_pekerjaan;?></h4>
</div>
<form class="m-b-1">
...
<?php echo form_open('admin/kandidats_pekerjaan/update_status', $attributes2, $hidden2);?>
<div class="modal-body">
  <div class="row">
    <div class="col-md-12">
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <select class="form-control" name="status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_umb_status');?>">
              <option value="0" <?php if($application_status=='0'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_pending');?></option>
              <option value="1" <?php if($application_status=='1'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_primary_selected');?></option>
              <option value="2" <?php if($application_status=='2'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_call_for_interview');?></option>
              <option value="3" <?php if($application_status=='3'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_confirm_del');?></option>
              <option value="4" <?php if($application_status=='4'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_rejected');?></option>
            </select>
          </div>
        </div>
      </div>
...
if($_GET['type']=='applicant'){
	$url = site_url("admin/kandidats_pekerjaan/applicants_list/").$pekerjaan_id;
} else if($_GET['type']=='candidate'){
	$url = site_url("admin/kandidats_pekerjaan/candidate_list/");
} else if($_GET['type']=='employer_applicant'){
	$url = site_url("admin/kandidats_pekerjaan/list_applicants_employer/").$user_id;
}
?>
