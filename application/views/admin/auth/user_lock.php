...
if($system[0]->enable_auth_background=='yes'):
	$auth_bg = 'style="background-position: center center; background-size: cover; background-image: url('.base_url().'skin/hrastral_assets/img/bg/bg-2.jpg");"';
else:
	$auth_bg = '';	
endif;
?>
  ...
  <div class="authentication-wrapper authentication-1 px-4">
    <div class="authentication-inner py-5">
      <div class="media align-items-center">
        ...
        <?php } else {?>
          <?php  if($iresult[0]->jenis_kelamin=='Pria') { ?>
        ...
        <div class="media-body ml-3">
          <div class="text-light small font-weight-semibold line-height-1 mb-1"><?php echo $this->lang->line('umb_lock_user_logged_in_as');?></div>
          <div class="text-xlarge font-weight-bolder line-height-1"><?php echo $iresult[0]->first_name;?> <?php echo $iresult[0]->last_name;?></div>
        </div>
      </div>
      <!-- Form -->
      <?php $attributes = array('name' => 'umb-form', 'id' => 'umb-form', 'class' => 'mt-4 form-hrastral', 'autocomplete' => 'off');?>
      <?php $hidden = array('_method' => 'forgott_pass');?>
      <?php echo form_open('admin/auth/unlock/', $attributes, $hidden);?>
      <p class="text-muted small"><?php echo $this->lang->line('umb_lock_user_session_timeout');?></p>
      <div class="input-group">
        <input type="password" class="form-control" name="ipassword" id="ipassword" placeholder="<?php echo $this->lang->line('umb_login_enter_password');?>">
        <div class="input-group-append"> 
          <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => 'btn btn-primary icon-btn save', 'content' => '<i class="ion ion-md-arrow-forward"></i> ')); ?> 
      ...
      <div class="text-center text-muted small"> 
        <?php echo $this->lang->line('umb_user_not_you');?> 
        <a href="<?php echo site_url('admin/logout');?>"><?php echo $this->lang->line('umb_user_logged_different');?></a> 
      </div>
    </div>
  </div>
  <!-- / Content --> 
