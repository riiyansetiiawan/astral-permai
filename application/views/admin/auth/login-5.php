...
<head>
  ...
  <link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url();?>skin/hrastral_assets/css/hrastral/umb_login_2.css">
  ...
  <div class="login-box animated fadeInDownBig"> 
    <?php if($this->session->flashdata('reset_password_success')):?>
      <div class="alert alert-success alert-dismissible">
        ...
        <?php echo $this->lang->line('umb_reset_password_sukses_sent_email');?> 
      </div>
    <?php endif;?>
    <div class="login-logo"> 
      <!--<b style="color:#FFF;"><?php echo $perusahaan[0]->nama_perusahaan;?></b>hrm--> 
      <img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $perusahaan[0]->sign_in_logo;?>" alt="logo HRASTRAL"> 
    </div>
    <div class="login-box-body">    
      <p class="login-box-msg"><?php echo $this->lang->line('umb_sign_in_page_title');?></p>
      <?php $attributes = array('class' => 'form-hrastral', 'name' => 'hrm-form', 'id' => 'hrm-form', 'data-redirect' => 'dashboard', 'data-form-table' => 'login', 'data-is-redirect' => '1', 'autocomplete' => 'off');?>
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-12"> <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat save', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('umb_login'))); ?> </div>
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="btn-group">
            <button type="button" class="btn btn-default btn-sm" data-toggle="dropdown" aria-expanded="false">Login Dengan</button>
            <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <span class="caret"></span> <span class="sr-only">Login Dengan</span> </button>
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="button" class="btn btn-success btn-block btn-flat btn-sm" onClick="window.location='<?php echo site_url('client/');?>'">Panel Client </button>
        </div>
        <!-- /.col --> 
      </div>
      <hr>
      <div class="lockscreen-footer text-center">
        ...
        <?php if($system[0]->enable_page_rendered=='yes'):?>
          - <?php echo $this->lang->line('umb_page_rendered_text');?> <strong>{elapsed_time}</strong> seconds.
        <?php endif; ?>
      </div>
    </div>
  </div>
