...
<body class="hold-transition login-page" style="background-position: center center; background-size: cover; background-image: url('<?php echo base_url();?>skin/hrastral_assets/img/bg/bg-4.jpg');">
  <div class="login-box animated fadeInDownBig"> 
    ...
    <div class="login-box-body">
      ...
      <p class="login-box-msg"><?php echo $this->lang->line('umb_admin_login');?><?php echo $perusahaan[0]->nama_perusahaan;?></p>
      ...
      <div class="row">
        ...
        <div class="col-xs-4"> <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat save', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('umb_login'))); ?> </div>
      </div>
      <?php echo form_close(); ?>
      <hr>
