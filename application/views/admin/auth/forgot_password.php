...
if($system[0]->enable_auth_background=='yes'):
	$auth_bg = 'style="background-position: center center; background-size: cover; background-image: url('.base_url().'skin/hrastral_assets/img/bg/21.jpg");"';
else:
	$auth_bg = '';	
endif;
?>
...
<div class="authentication-wrapper authentication-2 px-4">
  <div class="authentication-inner py-5"> 
    <!-- Form -->
    <?php $attributes = array('name' => 'umb-form', 'id' => 'umb-form', 'class' => 'form-horizontal card', 'autocomplete' => 'off');?>
    ...
    <div class="p-4 p-sm-5"> 
      ...
      <div class="d-flex justify-content-center align-items-center pb-2 mb-4">
        <div class="position-relative"> 
          <img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $perusahaan[0]->sign_in_logo;?>" alt="Logo HRASTAL"> 
        </div>
      </div>
      <!-- / Logo -->
      <h5 class="text-center text-muted font-weight-normal mb-4"><?php echo $this->lang->line('umb_reset_password_hr');?></h5>
      <hr class="mt-0 mb-4">
      <p> <?php echo $this->lang->line('umb_link_reset_password');?> </p>
      <div class="form-group">
        <input type="text" name="iemail" id="iemail" class="form-control" placeholder="<?php echo $this->lang->line('umb_enter_your_email_fg');?>">
        <a href="<?php echo site_url('admin/');?>" class="d-block small"><?php echo $this->lang->line('umb_remember_password');?></a>
      </div>
      <img id="hrload-img" src="<?php echo base_url()?>skin/img/loading.gif" style=""> <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat save', 'content' => '<i class="fa fa-unlock"></i> '.$this->lang->line('umb_hr_recover_password'))); ?> 
    </div>
    <?php echo form_close();?> 
    <!-- / Form --> 
  </div>
