...
<div class="authentication-wrapper authentication-3">
  <div class="authentication-inner"> 
    <!-- Side container --> 
    <div class="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover ui-bg-overlay-container p-5" style="background-image: url('<?php echo base_url();?>skin/hrastral_vendor/assets/img/bg/bg-3.jpg');">
      <div class="ui-bg-overlay bg-dark opacity-50"></div>
      <div class="w-100 text-white px-5">
        <h1 class="display-2 font-weight-bolder mb-4"><?php echo $this->lang->line('umb_admin_login');?><?php echo $perusahaan[0]->nama_perusahaan;?></h1>
        <div class="text-large font-weight-light"> <?php echo $theme_info[0]->text_page_login;?> </div>
      </div>
    </div>
        ...
        <div class="w-100"> 
          ...
          <div class="d-flex justify-content-center align-items-center">
            <div class="position-relative">
              <div class="p-1"><img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $perusahaan[0]->sign_in_logo;?>" alt="logo HRASTRAL"></div>
            </div>
          </div>
          <!-- / Logo -->
          <h4 class="text-center text-lighter font-weight-normal mt-5 mb-0"><?php echo $this->lang->line('umb_hrastral_login_ke_account_anda');?></h4>
          <?php
          ...
          <div class="form-group">
            <label class="form-label d-flex justify-content-between align-items-end">
              <div><?php echo $this->lang->line('umb_password_karyawan');?></div>
            ...
            <input type="password" class="form-control" id="ipassword" name="ipassword" placeholder="<?php echo $this->lang->line('umb_login_enter_password');?>">
          </div>
          <div class="d-flex justify-content-between align-items-center m-0">
            <label class="custom-control custom-checkbox m-0"> &nbsp; </label>
            <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => 'btn btn-primary save mr-2', 'content' => '<i class="saveinfo fas fa-user-lock d-blockd"></i> '.$this->lang->line('umb_login'))); ?> <img id="hrload-img" src="<?php echo base_url()?>skin/img/loading.gif" style=""> 
          </div>
          <?php echo form_close(); ?> 
