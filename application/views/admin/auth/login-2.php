...
<body>
  ...
  <div class="authentication-wrapper authentication-2 ui-bg-cover ui-bg-overlay-container px-4" style="background-image: url('<?php echo base_url();?>skin/hrastral_vendor/assets/img/bg/bg-3.jpg');">
    ...
    <div class="authentication-inner py-5">
      <div class="card">
        <div class="p-4 p-sm-5"> 
          ...
          <!-- / Logo -->
          <h5 class="text-center text-muted font-weight-normal mb-4"><?php echo $this->lang->line('umb_hrastral_login_ke_account_anda');?></h5>
          <!-- Form -->
