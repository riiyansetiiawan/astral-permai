  ...
  <ul class="nav nav-tabs step-anchor">
    <?php  if(in_array('80',$role_resources_ids)) {?>
      <li class="nav-item active"> 
        <a href="<?php echo site_url('admin/accounting/penerima_pembayarans/');?>" data-link-data="<?php echo site_url('admin/accounting/penerima_pembayarans/');?>" class="mb-3 nav-link hrastral-link"> 
      ...
      <div class="card">
        <div class="card-header with-elements"> 
          <span class="card-header-title mr-2">
            ...
            <?php echo $this->lang->line('umb_acc_penerima_pembayaran');?>
          </span> 
        </div>
        <div class="card-body">
          <?php $attributes = array('name' => 'add_penerima_pembayaran', 'id' => 'umb-form', 'autocomplete' => 'off');?>
          <?php $hidden = array('user_id' => $session['user_id']);?>
          <?php echo form_open('admin/accounting/add_penerima_pembayaran', $attributes, $hidden);?>
          <div class="form-group">
            <label for="nama_account"><?php echo $this->lang->line('umb_acc_penerima_pembayaran');?></label>
            <input type="text" class="form-control" name="nama_penerima_pembayaran" placeholder="<?php echo $this->lang->line('umb_acc_nama_penerima_pembayaran');?>">
          </div>
          <div class="form-group">
