...
<div class="row m-b-1 <?php echo $get_animate;?>">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_view');?></strong> <?php echo $this->lang->line('umb_hr_laporans_training');?></span> </div>
      <div class="card-body">
        ...
        <table class="datatables-demo table table-striped table-bordered" id="umb_table">
          <thead>
            <tr>
              ...
              <th><?php echo $this->lang->line('umb_durasi_training');?></th>
              <th><?php echo $this->lang->line('umb_cost');?></th>
