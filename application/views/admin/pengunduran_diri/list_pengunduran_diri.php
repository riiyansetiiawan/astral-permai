...
<?php if(in_array('213',$role_resources_ids)) {?>
  ...
  <div class="card mb-4 <?php echo $get_animate;?>">
    <div id="accordion">
      <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_add_new');?></strong> <?php echo $this->lang->line('umb_pengunduran_diri');?></span>
      ...
      <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
        <div class="card-body">
          <?php $attributes = array('name' => 'add_pengunduran_diri', 'id' => 'umb-form', 'autocomplete' => 'off');?>
          <?php $hidden = array('user_id' => $session['user_id']);?>
          <?php echo form_open('admin/pengunduran_diri/add_pengunduran_diri', $attributes, $hidden);?>
          <div class="bg-white">
            <div class="box-block">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group" id="ajax_karyawan">
                    <label for="karyawan"><?php echo $this->lang->line('umb_resignin_karyawan');?></label>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('umb_pengunduran_diri_reason');?>" name="reason" cols="30" rows="5" id="reason"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input class="form-control date" placeholder="<?php echo $this->lang->line('umb_tanggal_pengunduran_diri');?>" readonly name="tanggal_pengunduran_diri" type="text">
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <div class="card <?php echo $get_animate;?>">
    <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_list_all');?></strong> <?php echo $this->lang->line('left_pengundurans_diri');?></span> </div>
    <div class="card-body">
        ...
        <table class="datatables-demo table table-striped table-bordered" id="umb_table">
          <thead>
            <tr>
              ...
              <th width="350"><i class="fa fa-user"></i> <?php echo $this->lang->line('umb_nama_karyawan');?></th>
              ...
              <th><i class="fa fa-calendar"></i> <?php echo $this->lang->line('umb_tanggal_pengunduran_diri');?></th>
            </tr>
          </thead>
        </table>
      </div>
