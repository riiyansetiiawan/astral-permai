...
<?php $penunjukan = $this->Penunjukan_model->read_informasi_penunjukan($user[0]->penunjukan_id);?>
<?php
...
$cuti_user = $this->Umb_model->read_user_info($session['user_id']);
?>
            ...
            <div class="row no-gutters row-bordered row-border-light">
              <div class="col-md-3 pt-0">
                <div class="list-group list-group-flush account-settings-links">
                  <?php if($system[0]->karyawan_manage_own_profile=='yes'){?>
                    <a class="list-group-item list-group-item-action active" data-toggle="list" href="#account-basic_info">
                      <i class="lnr lnr-user text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_e_details_basic');?>
                    </a>
                  <?php } ?>
                  <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-gaji"> 
                    <i class="lnr lnr-highlight text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_gaji_title');?>
                  </a>
                  <?php if($system[0]->karyawan_manage_own_picture=='yes'){?>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-profile_picture"> 
                      <i class="lnr lnr-picture text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_e_details_profile_picture');?>
                    </a>
                  <?php } ?>
                  <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-immigration"> 
                    <i class="lnr lnr-rocket text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_karyawan_immigration');?>
                  </a>
                  <?php if($system[0]->karyawan_manage_own_kontak=='yes'){?>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-kontaks"> 
                      <i class="lnr lnr-phone-handset text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_karyawan_emergency_kontaks');?>
                    </a>
                  <?php } ?>
                  <?php if($system[0]->karyawan_manage_own_social=='yes'){?>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-social"> 
                      <i class="lnr lnr-earth text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_e_details_social');?>
                    </a>
                  <?php } ?>
                  <?php if($system[0]->karyawan_manage_own_document=='yes'){?>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-document"> 
                      <i class="lnr lnr-file-add text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_e_details_document');?>
                    </a>
                  <?php } ?>
                  <?php if($system[0]->karyawan_manage_own_qualification=='yes'){?>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-qualification"> 
                      <i class="lnr lnr-file-empty text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_e_details_qualification');?>
                    </a>
                  <?php } ?>
                  <?php if($system[0]->karyawan_manage_own_pengalaman_kerja=='yes'){?>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-pengalaman"> 
                      <i class="lnr lnr-hourglass text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_e_details_pengalaman_krj');?>
                    </a>
                  <?php } ?>
                  <?php if($system[0]->karyawan_manage_own_bank_account=='yes'){?>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-baccount"> 
                      <i class="lnr lnr-apartment text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_e_details_baccount');?>
                    </a>
                  <?php } ?>
                  <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-cpassword"> 
                    <i class="lnr lnr-lock text-lightest"></i> &nbsp; <?php echo $this->lang->line('umb_e_details_cpassword');?>
                  </a> 
                </div>
              </div>
              <div class="col-md-9">
                <div class="tab-content">
                  <?php if($system[0]->karyawan_manage_own_profile=='yes'){?>
                    <div class="tab-pane fade show active" id="account-basic_info">
                      <?php $info_shift = $this->Karyawans_model->read_infomasi_shift($user[0]->shift_kantor_id); ?>
                      <?php
                      ...
                      <div class="card-body media align-items-center"> <img src="<?php echo $de_file;?>" alt="" class="d-block ui-w-80">
                        <div class="media-body ml-4"> 
                          <a target="_blank" href="<?php echo site_url('admin/karyawans/download_profile/').$session['user_id'];?>">
                            <label class="btn btn-outline-primary"> <?php echo $this->lang->line('umb_download_profile_title');?> </label>
                          </a>
                          ...
                          <div class="box-body">
                            <div class="card-block">
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label class="form-label"><?php echo $this->lang->line('umb_karyawan_first_name');?></label>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label class="control-label form-label"><?php echo $this->lang->line('umb_karyawan_last_name');?></label>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label class="form-label"><?php echo $this->lang->line('umb_karyawan_dob');?></label>
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                  <div class="form-group">
                                    <label class="form-label control-label"><?php echo $this->lang->line('umb_jenis_kelamin_karyawan');?></label>
                                    <select class="form-control" name="jenis_kelamin" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_jenis_kelamin_karyawan');?>">
                                      <option value="Pria" <?php if($jenis_kelamin=='Pria'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_jenis_kelamin_pria');?></option>
                                      <option value="Perempuan" <?php if($jenis_kelamin=='Perempuan'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_jenis_kelamin_perempuan');?></option>
                                    </select>
                                  </div>
                                </div>
                                <div class="col-md-4">
                                  <div class="form-group">
                                    <label class="form-label control-label"><?php echo $this->lang->line('umb_karyawan_mstatus');?></label>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                    <label class="form-label control-label"><?php echo $this->lang->line('umb_nomor_kontak');?></label>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="<?php echo $this->lang->line('umb_alamat_karyawan');?>" name="alamat" cols="30" rows="3" id="alamat"><?php echo $alamat;?></textarea>
                                  </div>
                                </div>
                              </div>
                              <div class="form-actions box-footer"> <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => $this->Umb_model->form_button_class(), 'content' => '<i class="far fa-check-square"></i> '.$this->lang->line('umb_save'))); ?> </div>
                            </div>
                          </div>
                        </div>
                        <?php echo form_close(); ?> 
                                ...
                                <div class="col-md-12">
                                  <div class='form-group'>
                                    <fieldset class="form-group">
                                      <label for="logo"><?php echo $this->lang->line('umb_browse');?></label>
                                    ...
                                    <?php } ?>
                                    <?php if($profile_picture!='' && $profile_picture!='no file') {?> <br />
                                    <label>
                                      <input type="checkbox" class="minimal" value="1" id="remove_profile_picture" name="remove_profile_picture">
                                      <?php echo $this->lang->line('umb_e_details_remove_pic');?></span> 
                                    </label>
                                  <?php } else {?>
                    ...
                    <div class="card-body">
                      <div class="card-block">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="nomor_document" class="control-label"><?php echo $this->lang->line('umb_karyawan_nomor_document');?></label>
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="tanggal_terbit" class="control-label"><?php echo $this->lang->line('umb_tanggal_terbit');?></label>
                              <input class="form-control date" readonly="readonly" placeholder="<?php echo $this->lang->line('umb_tanggal_terbit');?>" name="tanggal_terbit" type="text">
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="tanggal_kaaluarsa" class="control-label"><?php echo $this->lang->line('umb_e_details_doe');?></label>
                  ...
                  <div class="tab-pane fade" id="account-kontaks">
                    <div class="box md-4">
                      <div class="card-header with-elements"> 
                        ...
                        <div class="card-body">
                          <div class="card-block">
                            ...
                            <div class="row">
                              <div class="col-md-5">
                                <div class="form-group">
                                  <label for="relation"><?php echo $this->lang->line('umb_e_details_relation');?></label>
                              ...
                              <div class="col-md-7">
                                <div class="form-group">
                                  <label for="email_kerja" class="control-label"><?php echo $this->lang->line('dashboard_email');?></label>
                              ...
                              <div class="col-md-5">
                                <div class="form-group">
                                  <label>
                                    ...
                                    <?php echo $this->lang->line('umb_e_details_pcontact');?></span> </label>
                                    &nbsp;
                                    <label>
                                      <input type="checkbox" class="minimal" value="1" id="is_dependent" name="is_dependent">
                                      <?php echo $this->lang->line('umb_e_details_dependent');?></span> </label>
                                    </div>
                                  </div>
                                  <div class="col-md-7">
                                    <div class="form-group">
                                      <input class="form-control" placeholder="<?php echo $this->lang->line('umb_e_details_dependent');?>" name="email_pribadi" type="text">
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-5">
                                    <div class="form-group">
                                      <label for="name" class="control-label"><?php echo $this->lang->line('umb_name');?></label>
                                ...
                                <div class="row">
                                  <div class="col-md-5">
                                    <div class="form-group">
                                      <label for="phone_kerja"><?php echo $this->lang->line('umb_phone');?></label>
                                      <div class="row">
                                        <div class="col-md-8">
                              ...
                              <div class="card-body">
                                <div class="card-block">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="title" class="control-label"><?php echo $this->lang->line('umb_e_details_dtitle');?></label>
                                        <input class="form-control" placeholder="<?php echo $this->lang->line('umb_e_details_dtitle');?>" name="title" type="text">
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="email" class="control-label"><?php echo $this->lang->line('umb_e_details_notifyemail');?></label>
                                        <input class="form-control" placeholder="<?php echo $this->lang->line('umb_e_details_notifyemail');?>" name="email" type="email">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <select name="send_mail" id="send_mail" class="form-control" data-plugin="select_hrm">
                                          ...
                                          <option value="2"><?php echo $this->lang->line('umb_no');?></option>
                                        </select>
                                      </div>
                                    </div>
                                  </div>
                                    ...
                                    <table class="table table-striped table-bordered dataTable" id="umb_table_document" style="width:100%;">
                                      <thead>
                                        <tr>
                                          ...
                                          <!--<th><?php echo $this->lang->line('umb_e_details_notifyemail');?></th>-->
                              ...
                              <div class="card-body">
                                <div class="card-block">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="name"><?php echo $this->lang->line('umb_e_details_inst_name');?></label>
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                      <div class="form-group">
                                        <label for="from_year" class="control-label"><?php echo $this->lang->line('umb_e_details_timeperiod');?></label>
                                        <div class="row">
                                          <div class="col-md-6">
                              ...
                              <div class="card-body">
                                <div class="card-block">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="post"><?php echo $this->lang->line('umb_e_details_post');?></label>
                              ...
                              <div class="card-body">
                                <div class="card-block">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="account_title"><?php echo $this->lang->line('umb_e_details_acc_title');?></label>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="nama_bank"><?php echo $this->lang->line('umb_e_details_nama_bank');?></label>
                                      ...
                                      <div class="form-group">
                                        <label for="kode_bank"><?php echo $this->lang->line('umb_e_details_kode_bank');?></label>
                        ...
                        <div class="tab-pane fade" id="account-gaji">
                          <div class="card-body pb-2">
                            <div class="box-body pb-2">
                              <div class="bg-white">
                                <div class="row">
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="form-label"><?php echo $this->lang->line('umb_karyawan_type_wages');?></label>
                                      <br />
                                      <?php if($type_upahh==1):?>
                                        <?php echo $this->lang->line('umb_payroll_gaji_pokok');?>
                                      <?php endif;?>
                                      <?php if($type_upahh==2):?>
                                        <?php echo $this->lang->line('umb_karyawan_upahh_harian');?>
                                      <?php endif;?>
                                    </div>
                                  </div>
                                  <div class="col-md-2">
                                    <div class="form-group">
                                      <label class="form-label"><?php echo $this->lang->line('umb_gaji_title');?></label>
                                      <br />
                                      <?php echo $this->Umb_model->currency_sign($gaji_pokok);?> 
                                    </div>
                                  </div>
                                </div>
                              </div>
              ...
              <div class="overflow-hidden">
                <div class="col-md-12">
                  <div class="tab-content">
                    <div class="row">
                      ...
                      <?php foreach($all_types_cuti as $type) {
                        if(in_array($type->type_cuti_id,$kategoris_cuti_ids)){?>
                          ...
                          $hlfcount =0;
                            //$count_l =0;
                          $cal_cuti_setengahari = karyawan_cal_cuti_setengahari($type->type_cuti_id,$session['user_id']);
                          foreach($cal_cuti_setengahari as $lhalfday):
                            $hlfcount += 0.5;
                          endforeach;
                          $count_l = count_info_cutii($type->type_cuti_id,$session['user_id']);
                    ...
                    <?php $cuti = $this->Timesheet_model->get_karyawan_cutii($session['user_id']); ?>
                    <div class="card">
                      <div class="card-header with-elements"> 
                        <span class="card-header-title mr-2"> 
                          <strong><?php echo $this->lang->line('umb_list_all');?></strong> 
                    ...
                    <div class="col-md-9">
                      <div class="tab-content">
                        <div class="tab-pane fade show active" id="account-awards">
                          ...
                          <?php $award = $this->Awards_model->get_awards_karyawan($session['user_id']); ?>
                          <div class="card-body">
                            <div class="box-datatable table-responsive">
                              <table class="datatables-demo table table-striped table-bordered umb_hrastral_table" id="umb_hr_table">
                                <thead>
                        ...
                        <div class="tab-pane fade" id="account-perjalanans">
                          ...
                          <?php $perjalanan = $this->Perjalanan_model->get_karyawan_perjalanan($session['user_id']); ?>
                          <div class="card-body">
                            <div class="box-datatable table-responsive">
                        ...
                        <div class="tab-pane fade" id="account-training">
                          ...
                          <?php $training = $this->Training_model->get_karyawan_training($session['user_id']); ?>
                          <div class="card-body">
                            <div class="box-datatable table-responsive">
                              <table class="datatables-demo table table-striped table-bordered umb_hrastral_table">
                                <thead>
                        ...
                        <div class="tab-pane fade" id="account-tickets">
                          <div class="card-header with-elements"> <span class="card-header-title mr-2"> <strong> <?php echo $this->lang->line('umb_list_all');?></strong> <?php echo $this->lang->line('left_tickets');?> </span> </div>
                          <?php $ticket = $this->Tickets_model->get_tickets_karyawans($session['user_id']);?>
                          <div class="card-body">
                            <div class="box-datatable table-responsive">
                              <table class="datatables-demo table table-striped table-bordered umb_hrastral_table">
                                <thead>
                                ...
                                <tbody>
                                  <?php foreach($ticket->result() as $r) { ?>
                                    <?php
                                    if($r->ticket_priority==1): $priority = $this->lang->line('umb_low'); 
                        ...
                        <div class="tab-pane fade" id="account-transfers">
                          ...
                          <?php $transfer = $this->Transfers_model->get_karyawan_transfers($session['user_id']); ?>
                          <div class="card-body">
                            <div class="box-datatable table-responsive">
                              <table class="datatables-demo table table-striped table-bordered umb_hrastral_table">
                                <thead>
                        ...
                        <div class="tab-pane fade" id="account-promotions">
                          ...
                          <?php $promotion = $this->Promotion_model->get_karyawan_promotions($session['user_id']); ?>
                          <div class="card-body">
                            <div class="box-datatable table-responsive">
                              <table class="datatables-demo table table-striped table-bordered umb_hrastral_table">
                                <thead>
                        ...
                        <div class="tab-pane fade" id="account-keluhans">
                          ...
                          <?php $keluhan = $this->Keluhans_model->get_karyawan_keluhans($session['user_id']); ?>
                          <div class="card-body">
                            <div class="box-datatable table-responsive">
                              <table class="datatables-demo table table-striped table-bordered umb_hrastral_table">
                                <thead>
                                  <tr>
                                    ...
                                    <th width="200">
                                      ...
                                      <?php echo $this->lang->line('umb_keluhan_dari');?></th>
                                      <th>
                                        <i class="fa fa-users"></i> 
                                        <?php echo $this->lang->line('umb_keluhan_terhadap');?></th>
                            ...
                            <div class="tab-pane fade" id="account-peringatans">
                              ...
                              <?php $peringatan = $this->Peringatan_model->get_peringatan_karyawan($session['user_id']); ?>
                              <div class="card-body">
                                <div class="box-datatable table-responsive">
                                  <table class="datatables-demo table table-striped table-bordered umb_hrastral_table">
                                    <thead>
                        ...
                        <div class="col-md-9">
                          <div class="tab-content">
                            <div class="tab-pane fade show active" id="account-projects">
                              ...
                              <?php $project = $this->Project_model->get_projects_karyawan($session['user_id']); ?>
                              <div class="card-body">
                                <div class="box-datatable table-responsive">
                                  <table class="datatables-demo table table-striped table-bordered umb_hrastral_table" id="umb_hr_table">
                                    <thead>
                            ...
                            <div class="tab-pane fade" id="account-tugass">
                              ...
                              <?php $tugas = $this->Timesheet_model->get_tugass_karyawan($session['user_id']); ?>
                              <div class="card-body">
                                <div class="box-datatable table-responsive">
                                  <table class="datatables-demo table table-striped table-bordered umb_hrastral_table">
                                    <thead>
