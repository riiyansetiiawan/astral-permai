...
<div class="box <?php echo $get_animate;?>">
  ...
  <div class="box-body">
    ...
    <h6>
      <a href="<?php echo base_url();?>uploads/csv/sample-csv-karyawans.csv" class="btn btn-primary"> 
    ...
    <?php echo form_open_multipart('admin/karyawans/import_karyawans', $attributes, $hidden);?>
    <div class="row">
      <div class="col-md-4">
