  ...
  <?php elseif($theme[0]->theme_option == 'template_2'):?>
    ...
    <?php elseif($theme[0]->theme_option == 'template_4' || $theme[0]->theme_option == 'template_5'):?>
      <div class="user-panel">
        ...
        <div class="info">
          <p><?php echo $user_info[0]->first_name. ' '.$user_info[0]->last_name;?></p>
          <a href="<?php echo site_url('admin/profile');?>" class="link" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('header_my_profile');?>">
            <i class="fa fa-user"></i>
          </a>
          <a href="<?php echo site_url('admin/profile?change_password=true')?>" class="link" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('umb_password_karyawan');?>">
            <i class="fa fa-key"></i>
          </a>
          <a href="<?php echo site_url('admin/logout');?>" class="link" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('header_sign_out');?>">
