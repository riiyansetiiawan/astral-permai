  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"> 
        ...
        <strong class="modal-title"><?php echo $this->lang->line('umb_delete_confirm');?></strong> 
      </div>
      <div class="alert alert-danger">
        <strong><?php echo $this->lang->line('umb_d_not_restored');?></strong>
      </div>
      ...
      <div class="modal-footer">
        ...
        ?>
        <?php echo form_button(array('data-dismiss' => 'modal', 'type' => 'button', 'class' => 'btn btn-secondary', 'content' => '<i class="fa far fa-check-square"></i> '.$this->lang->line('umb_close'))); ?> 
        <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => $this->Umb_model->form_button_class(), 'content' => '<i class="fa far fa-check-square"></i> '.$this->lang->line('umb_confirm_del'))); ?> <?php echo form_close(); ?> 
      </div>
    </div>
  </div>
</div>
...
<div class="modal fadeInRight edit-modal-data-variasi animated " id="edit-modal-data-variasi" role="dialog" aria-labelledby="edit-modal-data-variasi" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" id="ajax_modal_variasi"></div>
  </div>
</div>
<div class="modal fadeInRight edit-modal-data-timelog animated " id="edit-modal-data-timelog" role="dialog" aria-labelledby="edit-modal-data-timelog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" id="timelog"></div>
  </div>
</div>
...
<div class="modal fadeInUp view-modal-pengumuman animated " id="view-modal-data" role="dialog" aria-labelledby="view-modal-data" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" id="ajax_modal_pengumuman"></div>
  </div>
</div>
<div class="modal modal-slide fade" id="modal_payroll_template" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" id="ajax_modal_payroll"></div>
  </div>
</div>

<div class="modal modal-slide fade" id="modal_template_upahhperjam" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" id="ajax_modal_upahhperjam"></div>
  </div>
</div>
...
<div class="modal fadeInUp policy animated pulse" id="policy" role="dialog" aria-labelledby="policy" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" id="modal_kebijakan"></div>
  </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <?php echo form_open('', $attributes, $hidden);?> <?php echo form_button(array('data-dismiss' => 'modal', 'type' => 'button', 'class' => 'btn btn-secondary', 'content' => '<i class="fa far fa-check-square"></i> '.$this->lang->line('umb_close'))); ?> <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => $this->Umb_model->form_button_class(), 'content' => '<i class="fa far fa-check-square"></i> '.$this->lang->line('umb_confirm_del'))); ?> <?php echo form_close(); ?> 
      </div>
    </div>
  </div>
</div>
<div class="modal fadeInUp abouthr" id="abouthr" role="dialog" aria-labelledby="abouthr" aria-hidden="true">
  <div class="modal-dialog modal-xs">
    <div class="modal-content" id="modal_hr_tentang"></div>
  </div>
</div>
...
<div class="modal fadeInLeft delete-modal-tugas animated " role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"> <?php echo form_button(array('aria-label' => 'Close', 'data-dismiss' => 'modal', 'type' => 'button', 'class' => 'close', 'content' => '<span aria-hidden="true">×</span>')); ?> <strong class="modal-title"><?php echo $this->lang->line('umb_delete_confirm');?></strong> </div>
      <div class="alert alert-danger">
        <strong><?php echo $this->lang->line('umb_d_not_restored');?></strong>
      </div>
      <div class="modal-footer">
...
<div class="modal fadeInLeft delete-modal-variasi animated " role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"> 
        <?php echo form_button(array('aria-label' => 'Close', 'data-dismiss' => 'modal', 'type' => 'button', 'class' => 'close', 'content' => '<span aria-hidden="true">×</span>')); ?> 
