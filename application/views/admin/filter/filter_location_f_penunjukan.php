...
<div class="form-group" id="penunjukan_ajaxflt">
	<label class="form-label"><?php echo $this->lang->line('umb_penunjukan');?></label>
	<select class="form-control" name="penunjukan_id" id="filter_penunjukan" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_penunjukan');?>">
