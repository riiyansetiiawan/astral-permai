...
<section id="basic-listgroup">
  <div class="row match-heights <?php echo $get_animate?>">
      ...
      <div class="card">
        <div class="card-blocks">
          <div class="list-group"> 
            <a class="list-group-item list-group-item-action nav-tabs-link hrastral-tab-item active" href="#page_layout" data-profile="1" data-profile-block="page_layout" data-toggle="tab" aria-expanded="true" id="setting_1"> 
              <i class="fa fa-cubes"></i> <?php echo $this->lang->line('umb_page_layouts');?> 
            </a> 
            <a class="list-group-item list-group-item-action nav-tabs-link hrastral-tab-item" href="#notification" data-profile="4" data-profile-block="notification" data-toggle="tab" aria-expanded="true" id="setting_4"> 
              <i class="fa fa-exclamation-circle"></i> <?php echo $this->lang->line('umb_notification_position');?> 
            </a> 
            <a class="list-group-item list-group-item-action nav-tabs-link hrastral-tab-item" href="#form_design" data-profile="5" data-profile-block="form_design" data-toggle="tab" aria-expanded="true" id="setting_5"> 
              <i class="fa fa-edit"></i> <?php echo $this->lang->line('umb_theme_form_design');?> 
            </a> 
            <a class="list-group-item list-group-item-action nav-tabs-link hrastral-tab-item" href="#logo_perusahaan" data-profile="6" data-profile-block="logo_perusahaan" data-toggle="tab" aria-expanded="true" id="setting_6"> 
              <i class="fa fa-image"></i> <?php echo $this->lang->line('umb_system_logos');?> 
            </a> 
            <a class="list-group-item list-group-item-action nav-tabs-link hrastral-tab-item" href="#signin_logo" data-profile="7" data-profile-block="signin_logo" data-toggle="tab" aria-expanded="true" id="setting_7"> 
              <i class="fa fa-file-image-o"></i> <?php echo $this->lang->line('umb_theme_signin_page_logo_title');?> 
            </a> 
            <a class="list-group-item list-group-item-action nav-tabs-link hrastral-tab-item" href="#pekerjaan_page_logo" data-profile="8" data-profile-block="pekerjaan_page_logo" data-toggle="tab" aria-expanded="true" id="setting_8"> 
              <i class="fa fa-file-image-o"></i> <?php echo $this->lang->line('umb_theme_pekerjaan_page_logo_title');?>
            </a> 
            <a class="list-group-item list-group-item-action nav-tabs-link hrastral-tab-item" href="#logo_payroll" data-profile="9" data-profile-block="logo_payroll" data-toggle="tab" aria-expanded="true" id="setting_9"> 
              <i class="fa fa-camera-retro"></i> <?php echo $this->lang->line('umb_theme_logo_payroll_title');?> 
            </a>
            <?php if($system[0]->module_orgchart=='true'){?>
              <a class="list-group-item list-group-item-action nav-tabs-link hrastral-tab-item" href="#org_chart" data-profile="10" data-profile-block="org_chart" data-toggle="tab" aria-expanded="true" id="setting_10"> 
    ...
    <div class="col-md-9 current-tab animated fadeInRight" id="page_layout">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"> <?php echo $this->lang->line('umb_page_layouts');?> </h3>
        </div>
        <div class="box-body">
          <div class="box-block">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="notification_position"><?php echo $this->lang->line('umb_theme_page_headers');?></label>
                    <select class="form-control" name="page_header" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_theme_page_headers');?>">
                      <option value=""><?php echo $this->lang->line('umb_select_one');?></option>
                      <option value="breadcrumb-light" <?php if($page_header=='breadcrumb-light'){?> selected <?php }?>><?php echo $this->lang->line('umb_theme_breadcrumbs_transparent');?></option>
                      <option value="breadcrumb-transparent" <?php if($page_header=='breadcrumb-transparent'){?> selected <?php }?>><?php echo $this->lang->line('umb_theme_breadcrumbs_light');?></option>
                    </select>
                    <br/>
                    <small class="text-muted">
                      <i class="fa fa-arrow-circle-o-up"></i> <?php echo $this->lang->line('umb_theme_set_breadcrumbs');?>
                    </small> 
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="notification_position"><?php echo $this->lang->line('umb_theme_footer_layout');?></label>
                    <select class="form-control" name="footer_layout" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_theme_footer_layout');?>">
                      <option value=""><?php echo $this->lang->line('umb_select_one');?></option>
                      <option value="footer-light" <?php if($footer_layout=='footer-light'){?> selected <?php }?>><?php echo $this->lang->line('umb_theme_footer_light');?></option>
                      <option value="footer-dark" <?php if($footer_layout=='footer-dark'){?> selected <?php }?>><?php echo $this->lang->line('umb_theme_footer_dark');?></option>
                      <option value="footer-transparent" <?php if($footer_layout=='footer-transparent'){?> selected <?php }?>><?php echo $this->lang->line('umb_theme_footer_transparent');?></option>
                    </select>
                    <br/>
                    <small class="text-muted">
                      <i class="fa fa-arrow-circle-o-up"></i> 
                      <?php echo $this->lang->line('umb_theme_set_footer_layout');?>
                    </small> 
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="notification_position"><?php echo $this->lang->line('umb_theme_show_dashboard_cards');?></label>
                    ...
                    <small class="text-muted">
                      <i class="fa fa-arrow-circle-o-up"></i> 
                      <?php echo $this->lang->line('umb_theme_set_statistics_cards');?>
                    </small> 
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="notification_position"><?php echo $this->lang->line('umb_header_menu_animation_style');?></label>
                    <select class="form-control  input--dropdown js--animations" name="animation_style" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_select_one');?>">
                    ...
                    <header class="site__header island">
                      <div class="wrap"> <span id="animationSandbox" style="display: block;" class=""> <small class="site__title mega"><i class="fa fa-arrow-circle-o-up"></i> <?php echo $this->lang->line('umb_header_menu_animation_style_view_changes');?></small></span> </div>
                    </header>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="notification_position"> <?php echo $this->lang->line('umb_hrastral_themes_options');?></label>
                    <select class="form-control" name="theme_option" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_select_one');?>">
                      <option value=""><?php echo $this->lang->line('umb_select_one');?></option>
                      <option value="template_1" <?php if($theme_option=='template_1'){?> selected <?php }?>> <?php echo $this->lang->line('umb_hrastral_themes_option_1');?></option>
                      <option value="template_2" <?php if($theme_option=='template_2'){?> selected <?php }?>><?php echo $this->lang->line('umb_hrastral_themes_option_2');?></option>
                      <option value="template_3" <?php if($theme_option=='template_3'){?> selected <?php }?>>Template 3<?php //echo $this->lang->line('umb_hrastral_themes_option_2');?></option>
                      <option value="template_4" <?php if($theme_option=='template_4'){?> selected <?php }?>>Template 4<?php //echo $this->lang->line('umb_hrastral_themes_option_2');?></option>
                      <option value="template_5" <?php if($theme_option=='template_5'){?> selected <?php }?>>Template 5<?php //echo $this->lang->line('umb_hrastral_themes_option_2');?></option>
                      <option value="template_6" <?php if($theme_option=='template_6'){?> selected <?php }?>>Template 6<?php //echo $this->lang->line('umb_hrastral_themes_option_2');?></option>
                      <option value="template_7" <?php if($theme_option=='template_7'){?> selected <?php }?>>Template 7<?php //echo $this->lang->line('umb_hrastral_themes_option_2');?></option>
                      <option value="template_8" <?php if($theme_option=='template_8'){?> selected <?php }?>>Template 8<?php //echo $this->lang->line('umb_hrastral_themes_option_2');?></option>
                      <option value="template_9" <?php if($theme_option=='template_9'){?> selected <?php }?>>Template 9<?php //echo $this->lang->line('umb_hrastral_themes_option_2');?></option>
                    </select>
                    <br />
                    <small class="text-muted">
                      <i class="fa fa-arrow-circle-o-up"></i> 
                      <?php echo $this->lang->line('umb_hrastral_themes_options_details');?>
                    </small> 
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="notification_position"> <?php echo $this->lang->line('umb_hrastral_dashboard_options');?></label>
                    <select class="form-control" name="dashboard_option" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_select_one');?>">
                      ...
                      <option value="dashboard_2" <?php if($dashboard_option=='dashboard_2'){?> selected <?php }?>><?php echo $this->lang->line('umb_hrastral_dashboard_option_2');?></option>
                      ...
                      <option value="dashboard_4" <?php if($dashboard_option=='dashboard_4'){?> selected <?php }?>><?php echo $this->lang->line('umb_hrastral_dashboard_option_4');?></option>
                    </select>
                    <br />
                    <small class="text-muted">
                      <i class="fa fa-arrow-circle-o-up"></i> 
                      <?php echo $this->lang->line('umb_hrastral_dashboard_options_details');?>
                    </small> 
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="notification_position"> <?php echo $this->lang->line('umb_sign_in_page_options');?></label>
                    <select class="form-control" name="login_page_options" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_select_one');?>">
                      ...
                      <option value="login_page_4" <?php if($login_page_options=='login_page_4'){?> selected <?php }?>><?php echo $this->lang->line('umb_hrastral_login_v4');?></option>
                      <option value="login_page_5" <?php if($login_page_options=='login_page_5'){?> selected <?php }?>><?php echo $this->lang->line('umb_hrastral_login_v5');?></option>
                    </select>
                    <br />
                    <small class="text-muted">
                      <i class="fa fa-arrow-circle-o-up"></i> 
                      <?php echo $this->lang->line('umb_sign_in_page_option_details');?>
                    </small> 
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="nama_perusahaan" data-trigger="hover"> <?php echo $this->lang->line('umb_hrastral_show_calendar_on_dashboard');?> </label>
                    <br>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="nama_perusahaan" data-trigger="hover"> <?php echo $this->lang->line('umb_hr_sub_menu_icons');?> </label>
                    <br>
                    <div class="pull-xs-left m-r-1">
    ...
    <div class="col-md-9 current-tab animated fadeInRight" id="form_design" style="display:none;">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"> <?php echo $this->lang->line('umb_theme_form_design');?> </h3>
        </div>
        <div class="box-body">
          <div class="box-block">
            ...
            <div class="bg-white">
              <div class="row">
                <div class="col-md-5">
                  <div class="form-group">
                    <label for="notification_position"><?php echo $this->lang->line('umb_theme_form_design_input');?></label>
                    <select class="form-control" name="form_design" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_theme_form_design_input');?>">
                      <option value=""><?php echo $this->lang->line('umb_select_one');?></option>
                      <option value="basic_form" <?php if($form_design=='basic_form'){?> selected <?php }?>><?php echo $this->lang->line('umb_theme_default_input_design');?></option>
                      <option value="modern_form" <?php if($form_design=='modern_form'){?> selected <?php }?>><?php echo $this->lang->line('umb_theme_modern_form_design');?></option>
                      <option value="rounded_form" <?php if($form_design=='rounded_form'){?> selected <?php }?>><?php echo $this->lang->line('umb_theme_rounded_form_design');?></option>
                      <option value="default_square_form" <?php if($form_design=='default_square_form'){?> selected <?php }?>><?php echo $this->lang->line('umb_theme_default_square_form_design');?></option>
                      <option value="medium_square_form" <?php if($form_design=='medium_square_form'){?> selected <?php }?>><?php echo $this->lang->line('umb_theme_medium_square_form_design');?></option>
                    </select>
                    <br />
                    <small class="text-muted">
                      <i class="ft-arrow-up"></i> 
                      <?php echo $this->lang->line('umb_theme_set_form_design');?>
                    </small> 
                  </div>
                </div>
                <div class="col-md-12">
                  <p>
                    <label for="umb_theme_form_design">
                      <strong><?php echo $this->lang->line('umb_theme_basic_form_design');?></strong>
                    </label>
                  </p>
      ...
      <div class="col-md-9 current-tab animated fadeInRight" id="notification" style="display:none;">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title"> <?php echo $this->lang->line('umb_notification_position');?> </h3>
          </div>
          <div class="box-body">
            <div class="box-block">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <small class="text-muted">
                        <i class="ft-arrow-up"></i> 
                        <?php echo $this->lang->line('umb_set_position_for_notifications');?>
                      </small> 
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="nama_perusahaan"><?php echo $this->lang->line('umb_close_button');?></label>
                      <br>
                      <div class="pull-xs-left m-r-1">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="nama_perusahaan"><?php echo $this->lang->line('umb_progress_bar');?></label>
                      <br>
                      <div class="pull-xs-left m-r-1">
      ...
      <div class="col-md-9 current-tab animated fadeInRight" id="logo_perusahaan" style="display:none;">
        <div class="box mb-4">
          <div class="box-header with-border">
            <h3 class="box-title"> <?php echo $this->lang->line('umb_system_logos');?> </h3>
          </div>
          <div id="hrastral_1" class="box-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class='form-group'>
                  <fieldset class="form-group">
                    <label for="logo"><?php echo $this->lang->line('umb_first_logo');?></label>
                  ...
                  <small>- <?php echo $this->lang->line('umb_logo_whit_background_light_text');?></small> 
                </div>
                <div class="form-actions box-footer">
                  <button type="submit" class="btn btn-primary"> 
                    <i class="fa fa-check-square-o"></i> 
              ...
              <div class="col-md-6">
                <div class='form-group'>
                  <fieldset class="form-group">
                    <label for="logo"><?php echo $this->lang->line('umb_favicon');?></label>
        ...
        <div class="col-md-9 current-tab animated fadeInRight" id="signin_logo" style="display:none;">
          <div class="box mb-4">
            <div class="box-header with-border">
              <h3 class="box-title"> <?php echo $this->lang->line('umb_theme_signin_page_logo_title');?> </h3>
            </div>
            <div id="hrastral_2" class="box-body">
          ...
          <div class="col-md-9 current-tab animated fadeInRight" id="pekerjaan_page_logo" style="display:none;">
            <div class="box mb-4">
              <div class="box-header with-border">
                <h3 class="box-title"> 
                  <?php echo $this->lang->line('umb_theme_pekerjaan_page_logo_title');?> 
                  <small>(<?php echo $this->lang->line('left_frontend');?>)</small> 
                </h3>
              </div>
              <div id="hrastral_3" class="box-body">
            ...
            <div class="col-md-9 current-tab animated fadeInRight" id="logo_payroll" style="display:none;">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"> 
                    <?php echo $this->lang->line('umb_theme_logo_payroll_title');?> 
                    <small>(<?php echo $this->lang->line('umb_for_pdf');?>)</small> 
                  </h3>
                </div>
                <div id="hrastral_4" class="box-body">
              ...
              <?php if($system[0]->module_orgchart=='true'){?>
                <div class="col-md-9 current-tab animated fadeInRight" id="org_chart" style="display:none;">
                  <div class="box">
                    <div class="box-header with-border">
                      <h3 class="box-title"> <?php echo $this->lang->line('umb_title_org_chart');?> </h3>
                    </div>
                    <div class="box-body">
                      <div class="box-block">
                        ...
                        <div class="bg-white">
                          <div class="row">
                            <div class="col-md-4">
                              <div class="form-group">
                                <label for="notification_position"><?php echo $this->lang->line('umb_org_chart_layout');?></label>
                                ...
                                <small class="text-muted">
                                  <i class="ft-arrow-up"></i> 
                                  <?php echo $this->lang->line('umb_org_chart_set_layout');?>
                                </small> 
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                                <label for="export_file_title"><?php echo $this->lang->line('umb_org_chart_export_file_title');?></label>
                                ...
                                <small class="text-muted">
                                  <i class="ft-arrow-up"></i> 
                                  <?php echo $this->lang->line('umb_org_chart_export_file_title_details');?> 
                                </small> 
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                                <label for="export_orgchart" data-trigger="hover"> <?php echo $this->lang->line('umb_org_chart_export');?>
                                <button type="button" class="btn icon-btn btn-xs btn-outline-info itheme-btn borderless" data-toggle="popover" data-placement="top" data-content="<?php echo $this->lang->line('umb_org_chart_export_details');?>" data-trigger="hover" data-original-title="<?php echo $this->lang->line('umb_org_chart_export');?>">
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="export_orgchart" data-trigger="hover"> <?php echo $this->lang->line('umb_org_chart_zoom');?>
                              <button type="button" class="btn icon-btn btn-xs btn-outline-info itheme-btn borderless" data-toggle="popover" data-placement="top" data-content="<?php echo $this->lang->line('umb_org_chart_zoom_details');?>" data-trigger="hover" data-original-title="<?php echo $this->lang->line('umb_org_chart_zoom');?>"><span class="fa fa-question-circle"></span></button>
                            </label>
                            <div class="pull-xs-left m-r-1">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="export_orgchart" data-trigger="hover"> 
                              <?php echo $this->lang->line('umb_org_chart_pan');?>
                              <button type="button" class="btn icon-btn btn-xs btn-outline-info itheme-btn borderless" data-toggle="popover" data-placement="top" data-content="<?php echo $this->lang->line('umb_org_chart_pan_details');?>" data-trigger="hover" data-original-title="<?php echo $this->lang->line('umb_org_chart_pan');?>">
                                <span class="fa fa-question-circle"></span>
                              </button>
                            </label>
                            <div class="pull-xs-left m-r-1">
