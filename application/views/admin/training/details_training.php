...
<div class="row m-b-1 <?php echo $get_animate;?>">
  <div class="col-md-4 <?php echo $get_animate;?>">
    <div class="card">
      <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_details_training');?></strong></span> </div>
      <div class="box-body">
        <div class="box-block box-dashboard">
          <div class="table-responsive" data-pattern="priority-columns">
            <table class="datatables-demo table table-striped table-bordered">
              <tbody>
                <tr>
                  <th scope="row" style="border-top: 0px;"><?php echo $this->lang->line('left_type_training');?></th>
                  <td class="text-right"><?php echo $type;?></td>
                </tr>
                <?php $user = $this->Umb_model->read_user_info($session['user_id']);
                if($user[0]->user_role_id==1){?>
                  <tr>
                    <th scope="row"><?php echo $this->lang->line('umb_trainer');?></th>
                    <td class="text-right"><?php echo $nama_trainer;?></td>
                  </tr>
                <?php } ?>
                <tr>
                  <th scope="row"><?php echo $this->lang->line('umb_biaya_training');?></th>
                  <td class="text-right"><?php echo $this->Umb_model->currency_sign($biaya_training);?></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $this->Umb_model->set_date_format($finish_date);?></td>
                </tr>
                <tr>
                  <th scope="row"><?php echo $this->lang->line('umb_e_details_tanggal');?></th>
                  <td class="text-right"><?php echo $this->Umb_model->set_date_format($created_at);?></td>
                </tr>
                <?php if($status_training=='2'){?>
                  <tr>
                    <th scope="row"><?php echo $this->lang->line('dashboard_umb_status');?></th>
                    <td class="text-right"><?php echo '<span class="badge bg-green">'.$this->lang->line('umb_completed').'</span>';?></td>
                  </tr>
                <?php }?>
    ...
    <div class="col-md-8 <?php echo $get_animate;?>">
      <div class="card">
        <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_details');?></strong></span> </div>
        <div class="card-body">
          <div class="box-block card-dashboard">
            <div class="row">
              <div class="col-md-6">
                <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_training_karyawans_s');?></strong></span> </div>
                <div class="media-list" id="all_list_karyawans">
                  <ul class="list-group list-group-flush">
                    <?php if($karyawan_id!='') {?>
                      <?php $karyawan_ids = explode(',',$karyawan_id); foreach($karyawan_ids as $assign_id) {?>
                       ...
                       <li class="list-group-item" style="border:0px;">
                        ...
                        <!--<div class="media">
                      <?php if($user[0]->user_role_id==1):?>
                      <a class="media-left" href="<?php echo site_url()?>admin/karyawans/detail/<?php echo $e_name[0]->user_id;?>">
                      <?php endif;?>
            ...
            <?php if($user[0]->user_role_id==1){?>
              ...
              <?php } else {?>
                <div class="col-md-6">
                  ...
                  ?>
                  <div class="card-header with-elements mb-2"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_update_status');?></strong></span> </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="performance" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_performance');?>">
                          <option value="0" <?php if($performance=='0'):?> selected <?php endif;?>><?php echo $this->lang->line('umb_not_included');?></option>
                          <option value="1" <?php if($performance=='1'):?> selected <?php endif;?>><?php echo $this->lang->line('umb_satisfactory');?></option>
                          <option value="2" <?php if($performance=='2'):?> selected <?php endif;?>><?php echo $this->lang->line('umb_average');?></option>
                          <option value="3" <?php if($performance=='3'):?> selected <?php endif;?>><?php echo $this->lang->line('umb_poor');?></option>
                          <option value="4" <?php if($performance=='4'):?> selected <?php endif;?>><?php echo $this->lang->line('umb_excellent');?></option>
                        </select>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_umb_status');?>">
                          <option value="0" <?php if($status_training=='0'):?> selected <?php endif;?>><?php echo $this->lang->line('umb_pending');?></option>
                          <option value="1" <?php if($status_training=='1'):?> selected <?php endif;?>><?php echo $this->lang->line('umb_started');?></option>
                          <option value="2" <?php if($status_training=='2'):?> selected <?php endif;?>><?php echo $this->lang->line('umb_completed');?></option>
                          <option value="3" <?php if($status_training=='3'):?> selected <?php endif;?>><?php echo $this->lang->line('umb_terminated');?></option>
                        </select>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="remarks" rows="4" cols="15" placeholder="<?php echo $this->lang->line('umb_keterangan');?>"><?php echo $remarks;?></textarea>
                      </div>
                    </div>
                  </div>
            ...
            <?php } else {?>
              <div class="col-md-6">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title"> <?php echo $this->lang->line('umb_trainer');?> </h3>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="status"><?php echo $nama_trainer;?></label>
                    </div>
                  </div>
                </div>
                <?php echo form_close(); ?>
