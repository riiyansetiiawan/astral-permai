...
<div class="form-group">
	<label for="umb_department_head"><?php echo $this->lang->line('umb_trainer');?></label>
	<select name="trainer" id="trainer" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_trainer');?>">
		<option value=""></option>
