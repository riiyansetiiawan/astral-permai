          ...
          <div class="card-body">
            <div class="d-flex align-items-center">
              ...
              <div class="ml-3">
                ...
                <div class="text-large"><?php echo $this->Umb_model->currency_sign(dashboard_total_biaya());?></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="d-flex align-items-center">
              ...
              <div class="ml-3">
                <div class="text-muted small"><?php echo $this->lang->line('umb_kehadiran_total_cuti');?></div>
        ...
        <div class="card-body"> 
          <div class="row">
            ...
            <div class="col-6 col-xl-7 mb-3"> 
              <span class="text-big"><?php echo $this->Umb_model->currency_sign(hrastral_payroll_this_month());?></span> 
            </div>
            <div class="col-6 col-xl-5 text-muted mb-3"><?php echo $this->lang->line('umb_last_6_month');?></div>
            <div class="col-6 col-xl-7 mb-3"> 
              <span class="text-big"><?php echo $this->Umb_model->currency_sign(hrastral_payroll_6_bulan_terakhir());?></span> 
            </div>
            <div class="col-6 col-xl-5 text-muted mb-3"><?php echo $this->lang->line('umb_last_1_year');?></div>
            <div class="col-6 col-xl-7 mb-3"> 
              <span class="text-big"><?php echo $this->Umb_model->currency_sign(hrastral_payroll_1_tahun_terakhir());?></span> 
            </div>
            <div class="col-6 col-xl-5 text-muted mb-3"><?php echo $this->lang->line('umb_last_2_year');?></div>
            <div class="col-6 col-xl-7 mb-3"> 
              <span class="text-big"><?php echo $this->Umb_model->currency_sign(hrastral_payroll_2_tahun_terakhir());?></span> 
            </div>
              ...
              <a href="javascript:void(0)" class="card-body media align-items-center text-body"> 
                ...
                <span class="media-body d-block ml-3"> 
                  <span class="text-big font-weight-bolder">
                    <?php echo $this->Umb_model->currency_sign(dashboard_total_sales());?>             
                  </span><br>
