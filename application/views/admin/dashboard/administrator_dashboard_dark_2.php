          ...
          <div class="card mb-4 bg-info border-0 text-white">
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <div class="ml-3">
                  <div class="small"><?php echo $this->lang->line('umb_people');?></div>
        ...
        <div class="card mb-4 bg-success border-0 text-white">
          <div class="card-body">
            <div class="d-flex align-items-center">
              ...
              <div class="ml-3">
                <div class="small"><?php echo $this->lang->line('umb_roles');?></div>
          ...
          <div class="card mb-4 bg-warning border-0 text-white">
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <div class="ml-3">
                  <div class="small"><?php echo $this->lang->line('left_cuti');?></div>
          ...
          <div class="card mb-4 bg-danger border-0 text-white">
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <div class="ml-3">
                  <div class="small"><?php echo $this->lang->line('dashboard_total_gajii');?></div>
            ...
            <div class="card mb-4 bg-secondary border-0 text-white">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ml-3">
                    <div class="small"><?php echo $this->lang->line('umb_e_details_document');?></div>
                    <div class="text-big"><?php echo $this->lang->line('umb_performance_management');?></div>
                  </div>
                </div>
              </div>
          ...
          <div class="card mb-4 bg-danger border-0 text-white">
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <div class="ml-3">
                  <div class="small"><?php echo $this->lang->line('umb_configure_hr');?></div>
            ...
            <div class="card mb-4 bg-dark border-0 text-white">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ml-3">
                    <div class="small"><?php echo $this->lang->line('umb_tugass');?></div>
  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between">
          <div>
            <h5><span><?php echo $this->lang->line('umb_hrastral_present_today');?></span></h5>
