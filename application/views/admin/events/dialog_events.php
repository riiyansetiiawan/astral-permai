...
if(isset($_GET['jd']) && isset($_GET['event_id']) && $_GET['data']=='view_event'){
  ...
  <form class="m-b-1">
    <div class="modal-body">
      <p class="text-center text-big mb-4"><strong><?php echo $this->lang->line('umb_hr_view_event');?></strong></p>
          ...
          <tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <td style="display: table-cell;"><?php echo $this->Umb_model->set_date_format($event_date);?></td>
              </tr>
              ...
              <tr>
                <th><?php echo $this->lang->line('umb_hr_event_note');?></th>
      ...
      <?php } else if(isset($_GET['jd']) && isset($_GET['event_id']) && $_GET['data']=='event'){
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('umb_hr_edit_event');?></h4>
        </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="title"><?php echo $this->lang->line('umb_hr_event_title');?></label>
                <input class="form-control" placeholder="<?php echo $this->lang->line('umb_hr_event_title');?>" name="event_title" type="text" value="<?php echo $event_title;?>">
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="end_date"><?php echo $this->lang->line('umb_hr_event_time');?></label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="description"><?php echo $this->lang->line('umb_hr_event_note');?></label>
                <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('umb_hr_event_note');?>" name="event_note" cols="30" rows="5" id="event_note2"><?php echo $event_note;?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
     ...
     success: function (JSON) {
      if (JSON.error != '') {
       ...
       var umb_table = $('#umb_table').dataTable({
        "bDestroy": true,
        "ajax": {
         url : "<?php echo site_url("admin/events/list_events") ?>",
         type : 'GET'
       },
       dom: 'lBfrtip',
