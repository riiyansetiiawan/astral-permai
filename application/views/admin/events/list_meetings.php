...
<div class="row m-b-1 <?php echo $get_animate;?>">
  <?php if(in_array('273',$role_resources_ids)) {?>
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_add_new');?></strong> <?php echo $this->lang->line('umb_hr_meeting');?></span> </div>
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="title_meeting" placeholder="<?php echo $this->lang->line('umb_hr_title_meeting');?>">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control date" placeholder="<?php echo $this->lang->line('umb_hr_tanggal_meeting');?>" readonly name="tanggal_meeting" type="text">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="waktu_meeting"><?php echo $this->lang->line('umb_hr_waktu_meeting');?></label>
                <input class="form-control timepicker" placeholder="<?php echo $this->lang->line('umb_hr_waktu_meeting');?>" readonly name="waktu_meeting" type="text">
              </div>
            </div>
          </div>
          <div class="row">
    ...
    <div class="<?php echo $colmdval;?>">
      <div class="card">
        <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_list_all');?></strong> <?php echo $this->lang->line('umb_hr_meetings');?></span> </div>
        <div class="card-body">
