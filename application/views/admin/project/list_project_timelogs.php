...
<?php if(in_array('94',$role_resources_ids)) { ?>
  <li class="nav-item active"> <a href="<?php echo site_url('admin/project/timelogs/');?>" data-link-data="<?php echo site_url('admin/project/timelogs/');?>" class="mb-3 nav-link hrastral-link"> <span class="sw-icon fas fa-user-clock"></span> <?php echo $this->lang->line('umb_project_timelogs');?>
          ...
          <div class="bg-white">
            <div class="box-block">
              <div class="row">
                ...
                <?php if($user_info[0]->user_role_id == '1'){?>
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="project_id" id="project_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_project');?>">
                ...
                <?php } else {?>
                  <?php $r_projects = $this->Project_model->get_projects_karyawan($session['user_id']);?>
                  <div class="col-md-2">
                    <div class="form-group">
                      <label for="project_id" class="control-label"><?php echo $this->lang->line('umb_project');?></label>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <label for="timelogs_memo"><?php echo $this->lang->line('umb_project_timelogs_memo');?> <span id="total_time">&nbsp;</span></label>
