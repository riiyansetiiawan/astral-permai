...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/project/calendar_tugass/');?>" data-link-data="<?php echo site_url('admin/project/calendar_tugass/');?>" class="mb-3 nav-link hrastral-link">
      ...
      <div class="col-md-3">
        <div class="card">
            ...
            <div class="list-group" id="list_group">
              <span class="list-group-item calendar-options hrastral-drag-option" data-record="0"> <i class="ion ion-md-done-all text-success"></i> &nbsp; <?php echo $this->lang->line('umb_completed');?></span>
