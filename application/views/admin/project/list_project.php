...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  ...
  <?php if(in_array('44',$role_resources_ids)) { ?>
    <li class="nav-item active"> <a href="<?php echo site_url('admin/project/');?>" data-link-data="<?php echo site_url('admin/project/');?>" class="mb-3 nav-link hrastral-link"> <span class="sw-icon ion ion-logo-buffer"></span> <?php echo $this->lang->line('left_projects');?>
    ...
    <?php } else {?>
      ...
      $ol .= '';
		...
		if(in_array('316',$role_resources_ids)) { //edit
			$edit = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('umb_edit').'"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"  data-toggle="modal" data-target=".edit-modal-data"  data-project_id="'. $r->project_id . '"><span class="fa fa-pencil"></span></button></span>';
      ...
      <div class="card mb-4">
        <div class="card-body d-flex justify-content-between align-items-start pb-3">
          <div>
            ...
            ?>	
            <?php echo $status;?>
            <div class="text-muted small mt-1"><?php echo $this->lang->line('umb_project');?>#: <?php echo $r->no_project;?></div>
          </div>
          <div class="btn-group project-actions">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <?php if(in_array('316',$role_resources_ids)) { // Edit ?>
                <a class="dropdown-item" href="javascript:void(0)"  data-toggle="modal" data-target=".edit-modal-data" data-project_id="<?php echo $r->project_id;?>"><?php echo $this->lang->line('umb_edit');?></a>
              <?php } ?>
              <?php if(in_array('317',$role_resources_ids)) { // delete ?>
                <a class="dropdown-item delete" href="javascript:void(0)" data-toggle="modal" data-target=".delete-modal" data-record-id="<?php echo $r->project_id;?>"><?php echo $this->lang->line('umb_delete');?></a>
              <?php } ?>
            </div>
          </div>
        </div>
        <div class="progress rounded-0" style="height: 3px;">
          <div class="progress-bar <?php echo $progress_class;?>" style="width: <?php echo $r->progress_project;?>%;"></div>
        </div>
        <div class="card-body small pt-2 pb-0">
          <strong><?php echo $r->progress_project;?>%</strong> <?php echo $this->lang->line('umb_completed');?>
        </div>
        ...
        <hr class="m-0">
        <div class="card-body">
          <div class="text-muted small"><?php echo $this->lang->line('umb_project_client');?></div>
          <div class="mb-3"><a href="javascript:void(0)" class="text-body font-weight-semibold"><?php echo $name_client;?></a></div>
