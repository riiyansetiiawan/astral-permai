...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('umb_project_timelog_edit');?></h4>
</div>
...
<?php echo form_open('admin/project/update_project_timelog/'.$timelogs_id, $attributes, $hidden);?>
  <div class="modal-body">
    ...
    <div class="col-md-3">
      <div class="form-group">
        ...
        <input class="form-control etimepicker" placeholder="<?php echo $this->lang->line('umb_project_timelogs_starttime');?>" name="start_time" id="xstart_time" type="text" value="<?php echo $start_time;?>">
      </div>
    </div>
    <div class="col-md-3">
      <div class="form-group">
        <label for="end_time"><?php echo $this->lang->line('umb_project_timelogs_endtime');?></label>
        <input class="form-control etimepicker" placeholder="<?php echo $this->lang->line('umb_project_timelogs_endtime');?>" name="end_time" id="xend_time" type="text" value="<?php echo $end_time;?>">
      </div>
    </div>
    <div class="col-md-3">
      <div class="form-group">
        <label for="start_date"><?php echo $this->lang->line('umb_start_date');?></label>
        <input class="form-control <?php echo $user_date;?>" placeholder="<?php echo $this->lang->line('umb_start_date');?>" name="start_date" type="text" id="xstart_date" value="<?php echo $start_date;?>">
      </div>
    </div>
    <div class="col-md-3">
      <div class="form-group">
        <label for="end_date"><?php echo $this->lang->line('umb_end_date');?></label>
        <input class="form-control <?php echo $user_date;?>" placeholder="<?php echo $this->lang->line('umb_end_date');?>" name="end_date" type="text" id="xend_date" value="<?php echo $end_date;?>">
      </div>
    </div>                
  </div>
  <div class="row">
  <div class="col-md-12">
      <div class="form-group">
        ...
        <input class="form-control" placeholder="<?php echo $this->lang->line('umb_project_timelogs_memo');?>" name="timelogs_memo" type="text" value="<?php echo $timelogs_memo;?>">
      </div>
    </div>
  </div>
  </div>
...
$('.euser_timelog_date').bootstrapMaterialDatePicker({
	weekStart: 0,
	time: false,
	clearButton: false,
	format: 'YYYY-MM-DD'
});
$('.etimelog_date').bootstrapMaterialDatePicker({
	weekStart: 0,
	time: false,
	clearButton: false,
	format: 'YYYY-MM-DD'
	...
	$.ajax({
		...
		success: function (JSON) {
			if (JSON.error != '') {
				...
				"bDestroy": true,
				"ajax": {
					url : "<?php echo site_url('admin/project/list_project_timelogs');?>/<?php echo $project_id;?>",
					type : 'GET'
				},
