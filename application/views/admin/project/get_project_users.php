...
<?php $result = $this->Project_model->read_informasi_project($project_id);?>
...
<?php foreach($assigned_to as $assign_id) {?>
  ...
  <div class="il-item"> <a class="text-black" href="<?php echo site_url();?>admin/karyawans/detail/<?php echo $e_name[0]->user_id;?>/">
    <div class="media">
