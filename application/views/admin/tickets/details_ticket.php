  ...
  <div class="col-md-4">
    <section id="decimal">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_ticket');?></strong> <?php echo $this->lang->line('umb_details');?></span> </div>
            <div class="box-body">
              <div class="table-responsive">
                <div class="datatables-demo table table-striped table-bordered" data-pattern="priority-columns">
                  <?php
                  if($ticket_priority==1): $priority = $this->lang->line('umb_low'); elseif($ticket_priority==2): $priority = $this->lang->line('umb_medium'); elseif($ticket_priority==3): $priority = $this->lang->line('umb_high'); elseif($ticket_priority==4): $priority = $this->lang->line('umb_critical');  endif;
                  ?>
                  <table class="table table-striped m-md-b-0">
                    <tbody>
                      <tr>
                        <th scope="row" style="border-top:0px;"><?php echo $this->lang->line('umb_subject');?></th>
                      ...
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('dashboard_single_karyawan');?></th>
                        <td class="text-right">
                          <?php
                          $eticket_info = $this->Tickets_model->get_ticket_karyawans($ticket_id);
                          foreach($eticket_info as $eticket_id) {
                           $iassigned_to = $this->Umb_model->read_user_info($eticket_id->karyawan_id);
                           ?>
                           <?php echo $iassigned_to[0]->first_name.' '.$iassigned_to[0]->last_name.'<br>'; }?></td>
                         </tr>
                         <?php
                         $department = $this->Department_model->read_informasi_department($department_id);
                        ...
                        <tr>
                          <th scope="row"><?php echo $this->lang->line('umb_p_priority');?></th>
                        ...
                        <tr>
                          <th scope="row"><?php echo $this->lang->line('umb_created_at');?></th>
                        ...
                        <?php if($ticket_image!=0 || $ticket_image!=''):?>
                          <tr>
                            ...
                            <td class="text-right"><a href="<?php echo site_url()?>admin/download?type=ticket&filename=<?php echo $ticket_image;?>"><?php echo $this->lang->line('umb_download');?></a></td>
                          </tr>
                        <?php endif;?>
                        ...
                        <?php foreach($module_attributes as $mattribute):?>
                          <?php $attribute_info = $this->Custom_fields_model->get_data_custom_karyawan($ticket_id,$mattribute->custom_field_id);?>
                          <?php
          ...
          <div class="card">
            <div class="box-block">
              <ul class="nav nav-tabs nav-top-border no-hover-bg">
                <li class="nav-item active"> <a class="nav-link active" id="baseIcon-tab11" data-toggle="tab" aria-controls="tabIcon11" href="#tabIcon11" aria-expanded="true"><i class="fa fa-home"></i> <?php echo $this->lang->line('umb_details');?></a> </li>
                <li class="nav-item"> <a class="nav-link" id="baseIcon-tab12" data-toggle="tab" aria-controls="tabIcon12" href="#tabIcon12" aria-expanded="false"><i class="fa fa-comment"></i> <?php echo $this->lang->line('umb_payment_comment');?></a> </li>
                <li class="nav-item"> <a class="nav-link" id="baseIcon-tab13" data-toggle="tab" aria-controls="tabIcon13" href="#tabIcon13" aria-expanded="false"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('umb_ticket_files');?></a> </li>
                <li class="nav-item"> <a class="nav-link" id="baseIcon-tab14" data-toggle="tab" aria-controls="tabIcon14" href="#tabIcon14" aria-expanded="false"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('umb_note');?></a> </li>
              </ul>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        ...
                        ?>
                        <div class="card-header with-elements mb-3"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_update_status');?></strong></span> </div>
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group"> 
                              ...
                              <select class="form-control" name="status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_umb_status');?>">
                                <option value="1" <?php if($status_ticket=='1'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_open');?></option>
                                <option value="2" <?php if($status_ticket=='2'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_closed');?></option>
                              </select>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="status"><?php echo $this->lang->line('umb_keterangan');?></label>
                              <textarea class="form-control" name="remarks" rows="4" cols="15" placeholder="<?php echo $this->lang->line('umb_keterangan');?>"><?php echo $ticket_remarks;?></textarea>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="card-body">
                        ...
                        <div class="box-block">
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <textarea name="umb_comment" id="umb_comment" class="form-control" rows="4" placeholder="<?php echo $this->lang->line('umb_comment');?>"></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="row">
                        ...
                        <div class="clear"></div>
                        <div class="table-responsive">
                          <table class="table table-hover mb-md-0" id="umb_comment_table" style="width:100%;">
                            <thead>
                              <tr>
                    ...
                    <div class="tab-pane <?php echo $get_animate;?>" id="tabIcon13" aria-labelledby="baseIcon-tab13" aria-expanded="false">
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_list_attachment');?></strong></span> </div>
                    ...
                    <div class="tab-pane <?php echo $get_animate;?>" id="tabIcon14" aria-labelledby="baseIcon-tab14" aria-expanded="false">
                      <div class="card-body">
                        ...
                        <div class="box-block">
                          <div class="form-group">
                            <textarea name="ticket_note" id="ticket_note" class="form-control" rows="5" placeholder="<?php echo $this->lang->line('umb_ticket_note');?>"><?php echo $ticket_note;?></textarea>
                          </div>
                          <div class="form-actions box-footer">
                            <button type="submit" class="btn btn-primary"> <i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('umb_save');?> </button>
                          </div>
