...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="<?php echo $this->lang->line('umb_close');?>"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('umb_edit_ticket').' #'.$kode_ticket;?></h4>
</div>
    ...
    <div class="row">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <select name="ticket_priority" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_select_priority');?>">
                <option value=""></option>
                <option value="1" <?php if($ticket_priority==1):?> selected <?php endif;?>><?php echo $this->lang->line('umb_low');?></option>
                <option value="2" <?php if($ticket_priority==2):?> selected <?php endif;?>><?php echo $this->lang->line('umb_medium');?></option>
                <option value="3" <?php if($ticket_priority==3):?> selected <?php endif;?>><?php echo $this->lang->line('umb_high');?></option>
                <option value="4" <?php if($ticket_priority==4):?> selected <?php endif;?>><?php echo $this->lang->line('umb_critical');?></option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('umb_ticket_description');?>" name="description" cols="30" rows="5" id="description2"><?php echo $description;?></textarea>
        </div>
      </div>
    </div>
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var umb_table = $('#umb_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("admin/tickets/list_ticket") ?>",
							type : 'GET'
						},
