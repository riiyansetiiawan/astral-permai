  ...
  <div class="col-lg-8 col-md-8 current-tab <?php echo $get_animate;?>" id="general"  aria-expanded="false">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('umb_acc_payment_gateway_info');?></h3>
      </div>
      <div class="box-body">
        <div class="card-block">
          <legend><?php echo $this->lang->line('umb_acc_paypal_info');?></legend>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label for="paypal_email"><?php echo $this->lang->line('umb_acc_paypal_email');?></label>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-6">
                    <label for="paypal_sandbox_active"><?php echo $this->lang->line('umb_acc_paypal_sandbox_active');?></label>
                  ...
                  <div class="col-md-6">
                    <label for="paypal_active"><?php echo $this->lang->line('umb_karyawans_active');?></label>
              ...
              <div class="form-group">
                <label for="paypal_ipn_url"><?php echo $this->lang->line('umb_acc_paypal_ipn_url');?></label>
          ...
          <legend><?php echo $this->lang->line('umb_acc_stripe_info');?></legend>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label for="stripe_secret_key"><?php echo $this->lang->line('umb_acc_stripe_secret_key');?></label>
              ...
              <div class="form-group">
                <label for="paypal_ipn_url"><?php echo $this->lang->line('umb_acc_stripe_publlished_key');?></label>
              ...
              <div class="form-group">
                <label for="stripe_active"><?php echo $this->lang->line('umb_karyawans_active');?></label>
          ...
          <legend><?php echo $this->lang->line('umb_acc_online_payment_receive_account');?></legend>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label for="stripe_active"><?php echo $this->lang->line('umb_acc_account');?></label>
                <select name="bank_cash_id" id="select2-demo-6" class="form-control" data-plugin="umb_select" data-placeholder="<?php echo $this->lang->line('umb_acc_choose_account_type');?>">
                  <option value=""></option>
