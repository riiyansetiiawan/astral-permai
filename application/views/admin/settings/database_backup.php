...
<li class="nav-item active"> <a href="<?php echo site_url('admin/settings/database_backup/');?>" data-link-data="<?php echo site_url('admin/settings/database_backup/');?>" class="mb-3 nav-link hrastral-link"> <span class="sw-icon fa fa-database"></span> <?php echo $this->lang->line('header_db_log');?>
...
<div class="row mt-3">
  <div class="col-md-8 card">
    <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_add_new');?></strong> <?php echo $this->lang->line('umb_backup_log');?></span>
      <div class="card-header-elements ml-md-auto"> <span class="badge">
        ...
        <button type="submit" class="btn btn-xs btn-primary save"><?php echo $this->lang->line('umb_delete_old_backup');?></button>
        <?php echo form_close(); ?></span> <span class="badge">
          ...
          <button type="submit" class="btn btn-xs btn-primary save"><?php echo $this->lang->line('umb_create_backup');?></button>
            ...
            <table class="datatables-demo table table-striped table-bordered" id="umb_table">
              <thead>
                <tr>
                  ...
                  <th><?php echo $this->lang->line('umb_database_file');?></th>
      ...
      <div class="col-md-4 card">
        <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_restore');?></strong> <?php echo $this->lang->line('umb_database');?></span> </div>
          ...
          <div class="box">
            <div class="box-body">
              <div class="card-block">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group" id="ajx_restore">
                      <label class="form-label"><?php echo $this->lang->line('umb_database_choose_backup');?></label>
                      <select class="form-control" name="restore_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('umb_database_choose_backup');?>">
                        <?php $db_backup = $this->Umb_model->all_db_backup();?>
                        <option value=""><?php echo $this->lang->line('umb_database_choose_backup');?></option>
                ...
                <div class="form-actions box-footer"> <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => $this->Umb_model->form_button_class(), 'content' => '<i class="fas fa-database"></i> '.$this->lang->line('umb_restore'))); ?> </div>
                <div class="row">
                  <div class="col-md-12">
                    <label class="form-label control-label"><?php echo $this->lang->line('umb_database_restore_lost_current_data');?></label>
                  </div>
                </div>
              </div>
            </div>
