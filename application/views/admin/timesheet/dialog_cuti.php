...
<?php /*?><?php $kategoris_cuti = $user[0]->kategoris_cuti;?>
  ...
  <div class="row">       
    <div class="col-md-12">
      <div class="form-group">
        ...
        <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('umb_keterangan');?>" name="remarks" cols="30" rows="3"><?php echo $remarks;?></textarea>
      </div>
    </div>
    <div class="col-md-12">
      <div class="form-group">
...
<?php } else if(isset($_GET['jd']) && isset($_GET['cuti_id']) && $_GET['data']=='view_cuti'){
  ...
  <form class="m-b-1">
    <div class="modal-body">
      <h4 class="text-center text-big mb-4"><strong><?php echo $this->lang->line('umb_view');?> <?php echo $this->lang->line('left_cuti');?></strong></h4>
