  ...
  <div class="col-md-4 <?php echo $get_animate;?>">
    <section id="decimal">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_detail_tugas');?></strong></span> </div>
            <div class="box-body">
    ...
    <div class="col-xl-12 col-lg-12">
      <div class="card">
        <ul class="nav nav-tabs nav-topline">
          ...
          <li class="nav-item"> <a class="nav-link" id="baseIcon-tab13" data-toggle="tab" aria-controls="tabIcon13" href="#files" aria-expanded="false"><i class="fas fa-file-signature"></i> <?php echo $this->lang->line('umb_tugas_files');?></a> </li>
        ...
        <div class="tab-content pt-1">
          <div role="tabpanel" class="tab-pane active <?php echo $get_animate;?>" id="description" aria-expanded="true" aria-labelledby="description-tab11">
            <div class="card-body">
              <div class="row">
              	<div class="col-md-7">
                  <p class="mb-1 mt-2 ml-1"><?php echo html_entity_decode($description);?></p>
                </div>
                <div class="col-md-5">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="status" data-plugin="select_hrm" data-placeholder="Status">
                          ...
                          <option value="3" <?php if($status_tugas=='3'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_project_cancelled');?></option>
                          <option value="4" <?php if($status_tugas=='4'):?> selected <?php endif; ?>><?php echo $this->lang->line('umb_project_hold');?></option>
                        </select>
                      </div>
                    </div>
                  </div>
              ...
              <div class="tab-pane <?php echo $get_animate;?>" id="comments" aria-labelledby="baseIcon-tab12" aria-expanded="false">
                <div class="card-body">
                  ...
                  <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_all_comments');?></strong></span> </div>
                  <div class="card-body">
