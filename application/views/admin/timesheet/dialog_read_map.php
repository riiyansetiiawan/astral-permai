...
if(isset($_GET['jd']) && isset($_GET['ipaddress']) && $_GET['data']=='view_map'){
	...
	$att_location = $this->Umb_model->get_location_kehadiran_karyawan($_GET['uid'],$_GET['start_date']);	
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('umb_view_map_address');?></h4>
  </div>
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <script type="text/javascript">
            ...
            for (i = 0; i < get_locations.length; i++) {  
              marker = new google.maps.Marker({
                position: new google.maps.LatLng(get_locations[i][1], get_locations[i][2]),
                map: map
              });
              
              google.maps.event.addListener(marker, 'click', (function(marker, i) {
                return function() {
                  infowindow.setContent(get_locations[i][0]);
          ...
          <?php
		  /*} else {
			  echo $this->lang->line('umb_map_unable_get_location');
			}*/
      ?>
    </div>
  </div>
