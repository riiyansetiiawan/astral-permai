...
if(isset($_GET['jd']) && isset($_GET['quote_id']) && $_GET['data']=='po_quote'){
	...
	<div class="modal-header">
		...
		<h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('umb_title_quote_hash').$quote_number;?></h4>
	</div>
	<?php $attributes = array('name' => 'econvert_ke_project', 'id' => 'econvert_ke_project', 'autocomplete' => 'off', 'class'=>'m-b-1');?>
	...
	<div class="alert alert-success">
		<strong><?php echo $this->lang->line('umb_convert_estimate_invoice_confirm');?></strong>
	</div>
