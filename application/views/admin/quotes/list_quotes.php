...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/quotes/');?>" data-link-data="<?php echo site_url('admin/quotes/');?>" class="mb-3 nav-link hrastral-link"> <span class="sw-icon fa fa-tasks"></span> <?php echo $this->lang->line('umb_estimates');?>
...
<div class="card <?php echo $get_animate;?>">
  <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('umb_list_all');?></strong> <?php echo $this->lang->line('umb_title_quotes');?></span>
  	  <?php if(in_array('120',$role_resources_ids)) {?>
      <div class="card-header-elements ml-md-auto">
        <button type="button" class="btn btn-xs btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><?php echo $this->lang->line('umb_create_quote');?></button>
        <ul class="dropdown-menu">
       <?php foreach($all_perusahaans as $perusahaan) {?>
        <li><a href="<?php echo site_url('admin/quotes/create/');?>?c=<?php echo $perusahaan->perusahaan_id;?>"><?php echo $perusahaan->name?></a></li>
        <?php }?>
      </ul>
      </div>
      <?php }?>  
