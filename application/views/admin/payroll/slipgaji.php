...
if($system[0]->is_half_monthly==1){
	$check_pembayaran1 = $this->Payroll_model->read_melakukan_pembayaran_slipgaji_half_month_check_first($euser_id,$payment_date);
	$check_pembayaran2 = $this->Payroll_model->read_melakukan_pembayaran_slipgaji_half_month_check_last($euser_id,$payment_date);
	$check_pembayaran = $this->Payroll_model->read_melakukan_pembayaran_slipgaji_half_month_check($euser_id,$payment_date);
...
<div class="row">
  <div class="<?php echo $cmdp_1st;?>">
    <div class="card mb-4">
      <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $half_title.$this->lang->line('umb_slipgaji');?> - </strong> <?php echo date("F, Y", strtotime($payment_date));?></span>
    ...
    <div class="card">
      ...
      <div class="box-body">
        <div id="accordion">
          ...
          <div class="card hrastral-slipgaji">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_advance_gaji" aria-expanded="false"> <strong><?php echo $this->lang->line('umb_potongan_advance_gaji');?></strong> </a> </div>
            <div id="set_advance_gaji" class="collapse" data-parent="#accordion" style="">
              <div class="box-body ml-3 mr-3">
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                <tbody>
				  ...
				  ?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('umb_bayar_jumlah');?>:</strong> <span class="pull-right"> <?php echo $this->Umb_model->currency_sign($total_gaji_bersih);?></span></td>
                  </tr>
                  <?php endif;?>
