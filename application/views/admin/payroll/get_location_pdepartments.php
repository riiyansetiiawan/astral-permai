...
<div class="form-group" id="ajx_department">
	<label for="penunjukan"><?php echo $this->lang->line('left_department');?></label>
...
// get designations
jQuery("#aj_subdepartments").change(function(){
	jQuery.get(base_url+"/get_departemen_ppenunjukans/"+jQuery(this).val(), function(data, status){
