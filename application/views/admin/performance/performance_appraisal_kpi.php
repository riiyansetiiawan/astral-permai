    ...
    <div class="card-body">
      <div class="card-block nav-tabs-custom">
        <ul class="nav nav-tabs nav-top-border no-hover-bg">
          ...
          <li class="nav-item active"> <a style="background-color: #e2efda" class="nav-link active" id="baseIcon-tab12" data-toggle="tab" aria-controls="tabIcon12" href="#tabIcon12" aria-expanded="false"><i class="fa fa-line-chart"></i> <?php echo $this->lang->line('umb_all');?> <?php echo $this->lang->line('kpi_variable');?></a> </li>
        ...
        <!-- Main goals tab -->
        <div class="tab-content pt-1 hrastral-kpi">
          <div class="tab-pane" id="tabIcon11" aria-labelledby="baseIcon-tab11" aria-expanded="false">
            <div class="box <?php echo $get_animate;?>" style="border: .5px solid #ccc;"> <!-- Add main goals form --->
              <div class="box-header with-border">
                <h3 class="box-title"><?php echo $this->lang->line('umb_performance_kpi_maingoals');?></h3>
              ...
              <div class="box <?php echo $get_animate;?>" style="border: .5px solid #ccc;">
                <div class="box-header with-border">
                  <h3 class="box-title"> <?php echo $this->lang->line('umb_all');?> <?php echo $this->lang->line('kpi_main');?> </h3>
                </div>
                <div class="box-body collapse in">
                  <div class="box-block card-dashboard">
                    <div class="table-responsive" data-pattern="priority-columns">
            ...
            <div class="tab-pane active" id="tabIcon12" aria-labelledby="baseIcon-tab12" aria-expanded="false">
              <div class="box <?php echo $get_animate;?>" style="border: .5px solid #ccc;">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo $this->lang->line('umb_performance_kpi_variablekpi');?></h3>
                ...
                <div class="box <?php echo $get_animate;?>" style="border: .5px solid #ccc;">
                  <div class="box-header with-border">
                    <h3 class="box-title"> <?php echo $this->lang->line('umb_all');?> <?php echo $this->lang->line('kpi_variable');?> </h3>
                  </div>
                  <div class="box-body collapse in">
                    <div class="box-block card-dashboard">
                      <div class="table-responsive" data-pattern="priority-columns">
              ...
              <div class="tab-pane" id="tabIcon13" aria-labelledby="baseIcon-tab13" aria-expanded="false">
                <div class="box <?php echo $get_animate;?>" style="border: .5px solid #ccc;">
                  <div class="box-header with-border">
                    <h3 class="box-title"><?php echo $this->lang->line('umb_performance_kpi_incidental');?></h3>
                  ...
                  <div class="box <?php echo $get_animate;?>" style="border: .5px solid #ccc;">
                    <div class="box-header with-border">
                      <h3 class="box-title"> <?php echo $this->lang->line('umb_all');?> <?php echo $this->lang->line('kpi_incidental');?> </h3>
                    </div>
                    <div class="box-body collapse in">
                      <div class="box-block card-dashboard">
                        <div class="table-responsive" data-pattern="priority-columns">
