...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    <li class="nav-item active"> <a href="<?php echo site_url('admin/tujuan_tracking/');?>" data-link-data="<?php echo site_url('admin/tujuan_tracking/');?>" class="mb-3 nav-link hrastral-link"> <span class="sw-done-icon ion ion-md-checkmark"></span> <span class="sw-icon ion ion-ios-keypad"></span> <?php echo $this->lang->line('umb_hr_tujuan_tracking');?>
    <div class="text-muted small">Set up shortcuts</div>
  </a> </li>
  <li class="nav-item done"> <a href="<?php echo site_url('admin/post_pekerjaan/');?>" data-link-data="<?php echo site_url('admin/post_pekerjaan/');?>" class="mb-3 nav-link hrastral-link"> <span class="sw-done-icon ion ion-md-checkmark"></span> <span class="sw-icon ion ion-ios-color-wand"></span> <?php echo $this->lang->line('umb_hr_type_tujuan_tracking_se');?>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="box-datatable table-responsive">
        <table class="datatables-demo table table-striped table-bordered" id="umb_tujuans_table">
          <thead>
            <tr>
