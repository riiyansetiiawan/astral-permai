  ...
  <ul class="nav nav-tabs step-anchor">
    <?php if(in_array('312',$role_resources_ids)) { ?>
      <li class="nav-item done"> 
        <a href="<?php echo site_url('admin/project/dashboard_projects/');?>" data-link-data="<?php echo site_url('admin/project/dashboard_projects/');?>" class="mb-3 nav-link hrastral-link"> 
    ...
    <?php if(in_array('44',$role_resources_ids)) { ?>
      <li class="nav-item done"> 
        <a href="<?php echo site_url('admin/project/');?>" data-link-data="<?php echo site_url('admin/project/');?>" class="mb-3 nav-link hrastral-link"> 
    ...
    <?php if(in_array('119',$role_resources_ids)) { ?>
      <li class="nav-item active"> 
        <a href="<?php echo site_url('admin/clients/');?>" data-link-data="<?php echo site_url('admin/clients/');?>" class="mb-3 nav-link hrastral-link"> 
    ...
    <?php if(in_array('94',$role_resources_ids)) { ?>
      <li class="nav-item done"> 
        <a href="<?php echo site_url('admin/project/timelogs/');?>" data-link-data="<?php echo site_url('admin/project/timelogs/');?>" class="mb-3 nav-link hrastral-link"> 
    ...
    <?php if(in_array('424',$role_resources_ids)) { ?>
      <li class="nav-item done"> 
        <a href="<?php echo site_url('admin/project/calendar_projects/');?>" data-link-data="<?php echo site_url('admin/project/calendar_projects/');?>" class="mb-3 nav-link hrastral-link"> 
    ...
    <?php if(in_array('425',$role_resources_ids)) { ?>
      <li class="nav-item done"> 
        <a href="<?php echo site_url('admin/project/scrum_board_projects/');?>" data-link-data="<?php echo site_url('admin/project/scrum_board_projects/');?>" class="mb-3 nav-link hrastral-link"> 
          <span class="sw-icon fas fa-clipboard-list"></span> 
    ...
    <div id="accordion">
      <div class="card-header with-elements"> 
        <span class="card-header-title mr-2">
          ...
          <?php echo $this->lang->line('umb_project_client');?>
        </span>
      ...
      <div id="add_form" class="collapse add-form" data-parent="#accordion" style="">
        <div class="card-body">
          <?php $attributes = array('name' => 'add_client', 'id' => 'umb-form', 'autocomplete' => 'off');?>
