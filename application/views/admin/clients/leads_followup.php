...
<div class="row m-b-1 <?php echo $get_animate;?>">
    ...
    <div class="card">
      <div class="card-header with-elements"> 
        <span class="card-header-title mr-2">
          <strong><?php echo $this->lang->line('umb_details_lead');?></strong>
        </span> 
      </div>
  ...
  <div class="col-md-8 <?php echo $get_animate;?>">
    <div class="card">
      <div class="card-header with-elements"> 
        <span class="card-header-title mr-2">
          <strong><?php echo $this->lang->line('umb_lead_followup');?></strong>
        </span> 
      </div>
      <div class="card-body">
        <div class="box-datatable table-responsive">
          <table class="table table-striped table-bordered dataTable" id="umb_table" style="width:100%;">
            <thead>
              <tr>
                <th width="100"><?php echo $this->lang->line('umb_action');?></th>
                <th width="140"><?php echo $this->lang->line('umb_lead_next_followup');?></th>
      ...
      <div class="card-header with-elements"> 
        <span class="card-header-title mr-2">
          <strong><?php echo $this->lang->line('umb_lead_new_followup');?></strong>
        </span> 
      </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              <label for="next_followup"><?php echo $this->lang->line('umb_lead_next_followup');?></label>
              <input class="form-control date" placeholder="<?php echo $this->lang->line('umb_lead_next_followup');?>" name="next_followup" type="text">
            </div>
          </div>
          <div class="col-md-8">
            <div class="form-group">
              <label for="description"><?php echo $this->lang->line('umb_description');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('umb_description');?>" name="description" type="text" value="">
            </div>
          </div>
        </div>
        <div class="row">
