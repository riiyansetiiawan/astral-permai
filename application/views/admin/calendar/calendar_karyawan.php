            ...
            <div class="box-body">
              ...
              <div class="list-group"> 
               <?php if(in_array('8',$role_resources_ids)) { ?>
                <span class="list-group-item calendar-options text-green"> 
                  <i class="fa fa-space-shuttle"></i> <?php echo $this->lang->line('left_liburan');?>
                </span>
              <?php } ?>
              <?php if($system[0]->module_events=='true'){?>
                <?php if(in_array('98',$role_resources_ids)) { ?>
                  <span class="list-group-item calendar-options text-navy"> 
                    <i class="fa fa-calendar-plus-o"></i> 
                    <?php echo $this->lang->line('umb_hr_events');?>
                  </span>
                <?php } ?>
                <?php if(in_array('99',$role_resources_ids)) { ?>
                  <span class="list-group-item calendar-options text-teal"> 
