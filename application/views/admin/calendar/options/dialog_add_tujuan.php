...
if(isset($_GET['jd']) && isset($_GET['is_ajax']) && $_GET['data']=='event'){
  ...
  <?php $attributes = array('name' => 'add_tracking', 'id' => 'umb-form', 'autocomplete' => 'off', 'class' => 'm-b-1');?>
  <?php $hidden = array('user_id' => $session['user_id']);?>
  <?php echo form_open('admin/tujuan_tracking/add_tracking', $attributes, $hidden);?>
  <div class="modal-body">
    <h4 class="text-center text-big mb-4">
      <strong><?php echo $this->lang->line('umb_role_set');?> <?php echo $this->lang->line('umb_hr_title_tujuan');?></strong>
    </h4>
    <div class="bg-white">
      <div class="box-block">
        <div class="row">
              ...
              <?php } else {?>
               ...
               <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select name="perusahaan" id="aj_perusahaan" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('module_title_perusahaan');?>">
                    <option value=""></option>
                    <?php foreach($all_perusahaans as $perusahaan) {?>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('umb_subject');?>" name="subject" id="subject" type="text" value="">
              </div>
            </div>
          </div>
          <div class="row">
