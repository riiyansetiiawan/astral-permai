...
if(isset($_GET['jd']) && isset($_GET['is_ajax']) && $_GET['data']=='event'){
  ...
  <?php $attributes = array('name' => 'add_event', 'id' => 'umb-form', 'autocomplete' => 'off', 'class' => 'm-b-1');?>
  <?php $hidden = array('user_id' => $session['user_id']);?>
  <?php echo form_open('admin/events/add_event', $attributes, $hidden);?>
  <div class="modal-body">
    <h4 class="text-center text-big mb-4">
      <strong><?php echo $this->lang->line('umb_add_new');?> <?php echo $this->lang->line('umb_hr_event');?></strong>
    </h4>
    <div class="row">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="event_title" name="event_title" placeholder="<?php echo $this->lang->line('umb_hr_event_title');?>">
        <input type="hidden" value="#d81b60" name="event_color" readonly="readonly">
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input class="form-control edate" placeholder="<?php echo $this->lang->line('umb_hr_event_date');?>" readonly name="event_date" type="text" value="<?php echo $_GET['event_date'];?>" id="m_event_date">
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        <label for="event_time"><?php echo $this->lang->line('umb_hr_event_time');?></label>
        <input class="form-control etimepicker" placeholder="<?php echo $this->lang->line('umb_hr_event_time');?>" readonly name="event_time" type="text" id="m_event_time">
      </div>
    </div>
  </div>
  <div class="row">
