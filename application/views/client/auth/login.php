...
<body>
  ...
  <div class="authentication-wrapper authentication-1 px-4">
    <div class="authentication-inner py-5"> 
      ...
      <!-- Form -->
      <?php $ilogn_info = 'client1@hrastral.com';?>
      <?php $ilogn_info2 = 'client2@hrastral.com';?>
      ...
      <div class="form-group">
        <label class="form-label"><?php echo $this->lang->line('umb_login_email');?></label>
        <input type="text" class="form-control" id="iusername" name="iusername" placeholder="<?php echo $this->lang->line('umb_login_email');?>">
      </div>
      <div class="form-group">
        <label class="form-label d-flex justify-content-between align-items-end">
          <div><?php echo $this->lang->line('umb_login_enter_password');?></div>
          <a href="<?php echo site_url('client/auth/forgot_password');?>" class="d-block small"><?php echo $this->lang->line('umb_link_forgot_password');?></a>
        </label>
      ...
      <div class="d-flex justify-content-between align-items-center m-0">
        ...
        <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => 'btn btn-primary save mr-2', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('umb_login'))); ?> </div>
        <?php echo form_close(); ?> 
        <!-- / Form -->
     ...
     <script type="text/javascript" src="<?php echo base_url();?>skin/hrastral_vendor/hrastral_scripts/umb_client_login.js"></script> 
     <script type="text/javascript">
      $(document).ready(function(){
