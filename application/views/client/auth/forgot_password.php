...
<body>
  ...
  <div class="authentication-wrapper authentication-2 px-4">
    <div class="authentication-inner py-5"> 
      ...
      <!-- Form -->
      <?php $attributes = array('name' => 'umb-form', 'id' => 'umb-form', 'class' => 'form-hrastral', 'autocomplete' => 'off');?>
      ...
      <div class="p-4 p-sm-5"> 
        ...
        <div class="d-flex justify-content-center align-items-center pb-2 mb-4">
          <div class="position-relative"> <img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $perusahaan[0]->sign_in_logo;?>" alt="logo HRASTRAL"> </div>
        </div>
        <!-- / Logo -->
        ...
        <div class="form-group">
          ...
          <a href="<?php echo site_url('client/');?>" class="d-block small"><?php echo $this->lang->line('umb_remember_password');?></a> </div>
          <?php echo form_button(array('name' => 'hrastral_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat save', 'content' => '<i class="fa fa-unlock"></i> '.$this->lang->line('umb_hr_recover_password'))); ?> </div>
          <?php echo form_close();?> 
          <!-- / Form --> 
