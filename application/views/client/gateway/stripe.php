...
<?php $info_perusahaan = umb_info_perusahaan(1);?>
    ...
    <div class="col-md-4 col-md-offset-4" style="margin-top:100px;">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <h4 class="confirm-gateway">Invoice Number: <?php echo $nomor_invoice; ?></h4>
          ...
          <script
				...
				data-currency="usd"
				data-name="<?php echo $info_perusahaan->nama_perusahaan; ?>"
				data-description="Invoice payment"
				data-image="<?php echo base_url()."uploads/logo/".$info_perusahaan->logo; ?>"
				data-locale="auto">
			  </script>
          </form>
        </div>
