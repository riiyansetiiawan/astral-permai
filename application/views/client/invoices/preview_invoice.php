...
<?php if ($inv_record->num_rows() > 0) { ?>
      ...
      <button type="button" id="print-invoice" class="btn btn-vk btn-sm print-invoice"><i class="fa fa-print" aria-hidden="true"></i> <?php echo $this->lang->line('umb_print');?></button>
      </div>
      <?php } ?>
    </div>
  ...
  <div class="card-body p-5" id="print_invoice_hr">
    <div class="row">
      ...
      <div class="col-sm-6 text-right pb-4">
        ...
        <div>
          <h6><span>Invoice Total:</span> <?php echo $this->Umb_model->currency_sign($grand_total);?></h6>
          <?php $attributes = array('name' => 'add_item', 'id' => 'umb-form', 'autocomplete' => 'off');?>
          ...
          <button type="submit" style="margin-top:-2px" class="btn btn-info"><i class="fa fa-credit-card" aria-hidden="true"></i> <?php echo $this->lang->line('umb_acc_pay_now');?></button>
