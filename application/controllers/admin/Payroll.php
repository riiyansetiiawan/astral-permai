...
class Payroll extends MY_Controller {
	...
	public function pdf_create(){
		...
		<tr>
		<td align="center">'.$this->lang->line('umb_payroll_year_date').': '.$half_title.' <strong>'.date("F Y", strtotime($payment[0]->gaji_bulan)).'</strong></td>
		</tr>
		</table>
		';
		...
		if($payment[0]->type_slipgaji!='perjam'){
			...
			<td align="center"  valign="bottom">'.$this->Umb_model->currency_sign($itotal_count).'</td>	
			<td>&nbsp;</td>				
			</tr>';
		}			
		...
		if($payment[0]->type_slipgaji=='perjam'){
			...
			$total_earning = $etotal_count + $jumlah_tunjanagan + $jumlah_lembur + $jumlah_komissi + $jumlah_pembayarans_lainnya;
			...
			$fgaji = $total_earning - $total_potongan;
