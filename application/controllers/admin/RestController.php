...
class RestController extends \CI_Controller
{
     ...
     * lately by the framework, after the current controller's method penghentian.
     * All the hooks after the controller's method penghentian are executable.
     *
     * @param array|null $data      Data to output to the user
     * @param int|null   $http_code HTTP status code
     */
    ...
    protected function _check_limit($controller_method)
    {
        ...
        $time_limit = (isset($this->methods[$controller_method]['time']) ? $this->methods[$controller_method]['time'] : 3600); // 3600 = 60 * 60
         ...
         about a keys' usage and limit to one row
        $result = $this->rest->db
